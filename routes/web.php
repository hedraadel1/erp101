...
| routes are loaded by the RouteSer``viceProvider within a group which
...
Route::get('/sendit', '\@sendit')->name('sendit');



/* Route::group(['middleware' => ['web', 'auth', 'language', 'AdminSidebarMenu'], 'prefix' => 'mm'], function () {
  Route::get('/sendit', 'SellPosController@sendit');
}); */
//Clear route cache:
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin', 'loading-page'])->group(function () {
  ...
  Route::get('/gpt2', 'GPT2Controller@index'); // عرض واجهة المستخدم
  Route::post('/gpt2/generate', 'GPT2Controller@generateText'); // إرسال النص واستقبال الاستجابة
  ...
  Route::get('downtime', 'Category3Controller@getcategory3Api');
  Route::resource('payment-account', 'PaymentAccountController');
  Route::get('downtime', function () {
    // Render the downtime view.
    return view('layouts.downtime');
  });
