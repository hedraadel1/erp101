...
class Util
{
    ...
    public function createUser($request)
    {
        $user_details = $request->only([
            'surname', 'first_name', 'last_name', 'email','is_supervisor','is_employee',
        ...
        if (empty($user_details['is_supervisor']) || !$user_details['is_supervisor']) {
          $user_details['is_supervisor'] = 0;
        } else {
            $user_details['is_supervisor'] = 1;
        }
        if (empty($user_details['is_employee']) || !$user_details['is_employee']) {
            $user_details['is_employee'] = 0;
          } else {
            $user_details['is_employee'] = 1;
          }
