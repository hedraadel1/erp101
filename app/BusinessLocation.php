...
class BusinessLocation extends Model
{
    ...
    {
        $query = BusinessLocation::where('business_id', $business_id)->where('is_warehouse', '0')->where('is_sup_warehouse', '0')->Active();
    ...
    /**
     * return list of location and main warehouse
     */
    public static function forDropdownWithMainWarehouse($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
    ...
    /**
     * return list of location and main warehouse and sup warehouse
     */
    public static function forDropdownWithMainWarehouseAndSupWarehouse($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->Active();
