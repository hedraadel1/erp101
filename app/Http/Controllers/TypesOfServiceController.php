    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'TypesOfServiceController@edit\', [$id])}}" class="btn Btn-Brand btbn-sm Btn-Primary btn-modal" data-container=".type_of_service_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                    <button data-href="{{action(\'TypesOfServiceController@destroy\', [$id])}}" class="btn Btn-Brand btbn-sm btn-danger delete_type_of_service"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>'
                )
