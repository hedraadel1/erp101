...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home.index', compact('brand_store_products','sells_chart_1', 'sells_chart_2', 'widgets', 'business_locations','all_locations', 'common_settings', 'is_admin','installmets','contact'));
    }
    /*
    -task-4
