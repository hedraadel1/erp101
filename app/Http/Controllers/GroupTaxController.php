    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'GroupTaxController@edit\', [$id])}}" class="btn Btn-Brand Btn-bx  Btn-Primary btn-modal" data-container=".tax_group_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                        <button data-href="{{action(\'GroupTaxController@destroy\', [$id])}}" class="btn Btn-Brand Btn-bx  btn-danger delete_tax_group_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>'
                )
