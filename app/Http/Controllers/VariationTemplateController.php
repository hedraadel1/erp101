    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return Datatables::of($variations)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'VariationTemplateController@edit\', [$id])}}" class="btn Btn-Brand Btn-bx Btn-Primary edit_variation_button"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                        @if(empty($total_pv))
                        <button data-href="{{action(\'VariationTemplateController@destroy\', [$id])}}" class="btn  Btn-Brand Btn-bx btn-danger delete_variation_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                        @endif'
                )
