    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($discounts)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'DiscountController@edit\', [$id])}}" class="btn Btn-Brand Btn-bx Btn-Primary btn-modal" data-container=".discount_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                        <button data-href="{{action(\'DiscountController@destroy\', [$id])}}" class="btn Btn-Brand Btn-bx btn-danger delete_discount_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                        @if($is_active != 1)
                            &nbsp;
                            <button data-href="{{action(\'DiscountController@activate\', [$id])}}" class="btn Btn-Brand Btn-bx btn-success activate-discount"><i class="fa fa-circle-o"></i> @lang("lang_v1.reactivate")</button>
                        @endif
                        '
                )
