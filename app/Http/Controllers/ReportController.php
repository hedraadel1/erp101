...
// dd('hj');
            ...
            return ['total_sales_with_commission' =>
                        $sell_details['all_final_total'],
                    'total_commission' => $sell_details['total_sales_with_commission'],
                    'commission_percentage' => $commission_percentage
                ];
        }
    }
    ...
    public function getproductSellReport(Request $request)
    {
        ...
        return view('report.product_sell_report')
            ->with(compact('business_locations', 'users', 'customers', 'categories', 'brands', 
                'customer_group'));
    }
    ...
    public function itemsReport()
    {
        ...
        $business_locations = BusinessLocation::forDropdown($business_id);
        $users = User::allUsersDropdown($business_id, false);
        return view('report.items_report')->with(compact('users','suppliers', 'customers', 'business_locations'));
    }
