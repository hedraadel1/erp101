    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($return_transaction)) {
                ...
                if (!empty($pos_settings['enable_auto_return_purchase_paid'])) {
                $this->transactionUtil->autoPayContact($return_transaction->contact_id , $return_transaction->final_total , 'purchase_return');
                }
