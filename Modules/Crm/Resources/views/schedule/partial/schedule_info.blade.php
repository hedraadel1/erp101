<div class="row">
    <div class="col-md-12">
        ...
        <button type="button" class="btn btn-sm btn-danger schedule_delete pull-right m-5"
            data-href="{{ action('\Modules\Crm\Http\Controllers\ScheduleController@destroy', ['follow_up' => $schedule->id]) }}">
            <i class="fas fa-trash"></i>
            @lang('messages.delete')
        </button>
        <button type="button" class="btn btn-sm btn-primary schedule_edit pull-right m-5"
            data-href="{{ action('\Modules\Crm\Http\Controllers\ScheduleController@edit', ['follow_up' => $schedule->id]) }}?schedule_for=schedule_info">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    ...
                    @if ($schedule->allow_notification)
                        ...
                        <p class="text-muted">
                            @if (isset($schedule->notify_via['mail']))
                                @lang('crm::lang.email')
                                @if ($schedule->notify_via['sms'])
                                    {{ ', ' }}
                                @endif
                            @endif
                            @if (isset($schedule->notify_via['sms']))
                                @lang('crm::lang.sms')
                            @endif
                        </p>
                    @endif
