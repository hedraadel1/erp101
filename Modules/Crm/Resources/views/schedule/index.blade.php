                ...
                @if (auth()->user()->can('crm.access_all_schedule'))
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('assgined_to_filter', $assigned_to, null, [
                                'class' => 'form-control select2',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            ...
                            null,
                            ['class' => 'form-control select2', 'id' => 'follow_up_by_filter', 'placeholder' => __('messages.all')],
                        ) !!}
                    </div>
                </div>
            </div>
                ...
                @component('components.widget', ['class' => 'box box-solid', 'title' => __('crm::lang.all_schedules')])
                    @slot('tool')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="box-tools">
                                    <button type="button" class="btn button-add btn-add-schedule">
                            ...
                            <div class="col-md-6">
                                <div class="box-tools">
                                    ...
                                    <button type="button" class="btn button-add" data-toggle="modal"
                                        data-target="#advance_followup_modal">
                        ...
                        <input type="hidden" name="schedule_create_url" id="schedule_create_url"
                            value="{{ action('\Modules\Crm\Http\Controllers\ScheduleController@create') }}">
                    @endslot
                    <div class="col-sm-12">
