...
@section('content')
    ...
    <section class="content no-print">
        <div class="row row-custom">
            ...
            @endcan
            <!-- /.col -->
            @if (auth()->user()->can('crm.access_all_leads') ||
            ...
            @can('crm.access_sources')
                <div class="col-md-3">
                    <div class="box box-solid">
                        <div class="box-body p-10 table-responsive">
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        ...
                        <a data-href="{{ action('\Modules\Crm\Http\Controllers\CampaignController@create') }}"
                            class="btn btn-success btn-xs" id="wish_birthday">
