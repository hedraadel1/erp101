<div class="modal-dialog no-print" role="document">
    {!! Form::open([
        'url' => action('\Modules\Accounting\Http\Controllers\TransactionController@saveMap'),
        'method' => 'POST',
        'id' => 'save_accounting_map',
    ]) !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'payment_account',
                            !is_null($default_payment_account) ? [$default_payment_account->id => $default_payment_account->name] : [],
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'deposit_to',
                            !is_null($default_deposit_to) ? [$default_deposit_to->id => $default_deposit_to->name] : [],
