...
Route::group(['middleware' => ['web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'], 'prefix' => 'accounting', 'namespace' => 'Modules\Accounting\Http\Controllers'], function () {
    ...
    Route::prefix('settings')->group(function () {
        ...
        Route::prefix('map_setting')->group(function () {
            Route::get('/', 'AccountingSettingsController@map_settings');
            Route::post('store', 'AccountingSettingsController@store_map_settings');
            Route::get('{id}/edit', 'AccountingSettingsController@edit_map_settings');
            Route::post('{id}/update', 'AccountingSettingsController@update_map_settings');
            Route::delete('{id}/destroy', 'AccountingSettingsController@destroy_map_setting');
        });
