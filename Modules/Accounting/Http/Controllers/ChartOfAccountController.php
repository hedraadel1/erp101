...
class ChartOfAccountController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
          if ($this->isGlCodeExitis($request->gl_code)) {
            (new FlashService())->onWarning('code is unique');
    ...
    public function isGlCodeExitis($code){
        $code =  ChartOfAccount::where('business_id',session('business.id'))->where('gl_code',$code)->first();
