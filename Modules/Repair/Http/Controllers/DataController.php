...
class DataController extends Controller
{
   ...
   */
    ...
    public function user_permissions()
    {
        return [
          [
            'value' => 'repair.view_dashboard',
            'label' => __('repair::lang.view_dashboard'),
            'default' => false
        ],
            [
                'value' => 'repair.create',
    ...
    public function modifyAdminMenu()
    {
        ...
        $is_product_enabled =   is_product_enabled('229');
        ...
        if (($is_repair_enabled ||$is_product_enabled)&& (auth()->user()->can('superadmin') || auth()->user()->can('repair.view') || auth()->user()->can('job_sheet.view_assigned') || auth()->user()->can('job_sheet.view_all')|| auth()->user()->can('repair.view_dashboard'))) {
