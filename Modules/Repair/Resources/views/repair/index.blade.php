...
@section('content')
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters'), 'closed' => false])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('repair_status_id', $repair_status_dropdown['statuses'], null, [
            ...
            @if (in_array('service_staff', $enabled_modules) && !$is_service_staff)
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('service_staff_id', $service_staffs, null, [
                            'class' => 'form-control select2',
                            'style' => 'width:100%',
                            'placeholder' => __('lang_v1.all'),
                        ]) !!}
                        ...
                        <div class="tab-pane active" id="pending_repair_tab">
                            <div class="row">
                                <div class="col-md-12 mb-12">
                                    <a target="_blank" class="btn btn-sm button-add pull-right"
                                        href="{{ action('SellPosController@create') . '?sub_type=repair' }}">
                                ...
                                <table class="table table-bordered table-striped ajax_view" id="pending_repair_table">
                                    ...
                                    <tfoot>
                                        <tr class="bg-gray font-17 footer-total text-center">
                                            <td
                                                @if (in_array('service_staff', $enabled_modules)) colspan="11"
                                            @else
                                                colspan="10" @endif>
                                            ...
                                            <td>
                                                <span class="display_currency" id="pending_repair_footer_total"
                                ...
                                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                                    ...
                                    <tfoot>
                                        <tr class="bg-gray font-17 footer-total text-center">
                                            ...
                                            <td>
                                                <span class="display_currency" id="footer_sale_total"
                                                    data-currency_symbol="true"></span>
                                            </td>
                                            <td class="text-left">
                                                <small>
                                                    <span class="display_currency" id="footer_total_remaining"
                                                        data-currency_symbol="true"></span>
                                                </small>
                                            </td>
        ...
        <div class="modal fade" id="edit_repair_status_modal" tabindex="-1" role="dialog"
        ...
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'repair_due_date',
                        name: 'repair_due_date'
                    },
                    {
                        data: 'job_sheet_no',
                        name: 'rjs.job_sheet_no'
                    },
                    {
                        data: 'invoice_no',
                        name: 'invoice_no'
                    ...
                    {
                        data: 'repair_serial_no',
                        name: 'transactions.repair_serial_no'
                    },
                    {
                        data: 'repair_status',
                        name: 'rs.name'
                ...
                "fnDrawCallback": function(oSettings) {
                    ...
                    $('#footer_total_sell_return_due').text(sum_table_col($('#sell_table'),
                        'sell_return_due'));

                    $('#footer_payment_status_count').html(__sum_status_html($('#sell_table'),
                        'payment-status-label'));

                    $('#footer_repair_status_count').html(__sum_status_html($('#sell_table'),
                        'edit_repair_status'));
            ...
            pending_repair_table = $('#pending_repair_table').DataTable({
                ...
                "fnDrawCallback": function(oSettings) {
                    ...
                    $('#pending_repair_footer_total').text(sum_table_col($('#pending_repair_table'),
                        'final-total'));

                    $('#pending_repair_footer_total_remaining').text(sum_table_col($(
                        '#pending_repair_table'), 'payment_due'));

                    $('#pending_repair_footer_total_sell_return_due').text(sum_table_col($(
                        '#pending_repair_table'), 'sell_return_due'));

                    $('#pending_repair_footer_payment_status_count').html(__sum_status_html($(
                        '#pending_repair_table'), 'payment-status-label'));

                    $('#footer_pending_repair_status_count').html(__sum_status_html($(
                        '#pending_repair_table'), 'edit_repair_status'));
            ...
            $(document).on('change',
                '#sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #service_staff_id, #repair_status_id, #created_by',
                function() {
                    sell_table.ajax.reload();
                    pending_repair_table.ajax.reload();
                });
