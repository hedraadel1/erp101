<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('\Modules\Essentials\Http\Controllers\EssentialsLeaveTypeController@update', [$leave_type->id]),
            'method' => 'put',
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <hr>
                <label class="radio-inline">
                    <input type="checkbox" {{ $leave_type->is_paid == '0' ? 'checked' : '' }} value="0"
                        name="is_paid">اجازة غير
                    مدفوعة
                    {{-- {!! Form::checkbox('is_paid', '0' , []) !!} اجازة غير مدفوعة --}}
                </label>
