                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::select(
                                    ...
                                    ['final' => __('sale.final'), 'draft' => __('sale.draft')],
                            ...
                            @foreach ($payrolls as $employee => $payroll)
                                ...
                                <tr data-id="{{ $employee }}">
                                    ...
                                    <td>
                                        {{ $payroll['name'] }}
                                        <br><br>
                                        <b>{{ __('essentials::lang.leaves') }} {{ __('essentials::lang.paid') }}:</b>
                                        {{ __('essentials::lang.total_leaves_days', ['total_leaves' => $payroll['total_leaves']]) }}
                                        <br><br>
                                        <b>الاجازات العامه:</b>
                                        {{ __('essentials::lang.total_leaves_days', ['total_leaves' => $payroll['total_global_leaves']]) }}
                                        <br><br>
                                        <b>العطلات الاسبوعية:</b>
                                        {{ __('essentials::lang.total_leaves_days', ['total_leaves' => $payroll['total_days_holiday']]) }}
                                        <br><br>
                                    ...
                                    <td>
                                        ...
                                        {!! Form::text('payrolls[' . $employee . '][essentials_duration]', $payroll['total_work_duration'], [
                                        ...
                                        @component('components.widget')
                                            <table class="table table-condenced allowance_table"
                                                ...
                                                <tbody>
                                                    ...
                                                    @endif
                                                    @if (!empty($payroll['leaves']))
                                                        @foreach ($payroll['leaves']['allowance_names'] as $key => $value)
                                                            @include(
                                                                'essentials::payroll.allowance_and_deduction_row',
                                                                [
                                                                    'add_button' =>
                                                                    ...
                                                                    'name' => $value,
                                                                    'value' =>
                                                                        $payroll['leaves']['allowance_amounts'][
                                                                            $key
                                                                        ],
                                                                    'amount_type' =>
                                                                        $payroll['leaves']['allowance_types'][
                                                                            $key
                                                                        ],
                                                                    // 'percent' =>
                                                                    //     $payroll['leaves'][
                                                            ...
                                                            @php
                                                                $total_allowances += $payroll['leaves']['allowance_amounts'][$key];
                                                            @endphp
                                                        @endforeach
                                                    @endif
                                                    @if (!empty($payroll['global_leaves']))
                                                        @foreach ($payroll['global_leaves']['allowance_names'] as $key => $value)
                                                            @include(
                                                                'essentials::payroll.allowance_and_deduction_row',
                                                                [
                                                                    'add_button' =>
                                                            ...
                                                            @php
                                                                $total_allowances += $payroll['global_leaves']['allowance_amounts'][$key];
                                                            @endphp
                                                        @endforeach
                                                    @endif
                                                    @if (!empty($payroll['days_holiday']))
                                                        @foreach ($payroll['days_holiday']['allowance_names'] as $key => $value)
                                                            @include(
                                                                'essentials::payroll.allowance_and_deduction_row',
                                                                [
                                                                    'add_button' =>
                                                            ...
                                                            @php
                                                                $total_allowances += $payroll['days_holiday']['allowance_amounts'][$key];
                                                            @endphp
                                                        @endforeach
                                                    @endif
                                                </tbody>
