            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        @if ($todo->is_received == 0)
                            <form style="    float: left;"
                                action="{{ action('\Modules\Essentials\Http\Controllers\ToDoController@changeReceived') }}"
                                method="post">
                                @csrf
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" id="received_task"> استلام
                                        التاسك</button>
                                    {!! Form::hidden('task_id', $todo->id, ['id' => 'task_id']) !!}
                                </div>
                            </form>
                        @endif
                    </div>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                {{ optional($todo->assigned_by)->user_full_name }}<br>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="comments_tab">
                                <div class="row">
                                    {!! Form::open([
                                        'url' => action('\Modules\Essentials\Http\Controllers\ToDoController@addComment'),
                            ...
                            <div class="tab-pane" id="documents_tab">
                                <div class="row">
                                    {!! Form::open([
                                        'url' => action('\Modules\Essentials\Http\Controllers\ToDoController@uploadDocument'),
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ $media->display_url }}" download
                                                            ...
                                                            @if (in_array(auth()->user()->id, [$media->uploaded_by, $todo->created_by]))
                                                                <a href="{{ action('\Modules\Essentials\Http\Controllers\ToDoController@deleteDocument', $media->id) }}"
                                                                    class="btn btn-danger btn-xs delete-document"
                                                                    data-media_id="{{ $media->id }}"><i
                                                                        class="fa fa-trash"></i> @lang('messages.delete')</a>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
