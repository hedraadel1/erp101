<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open([
            'url' => action('\Modules\Essentials\Http\Controllers\ToDoController@update', $todo->id),
            'id' => 'task_form',
            'method' => 'put',
        ]) !!}
        ...
        <div class="modal-body">
            <div class="row">
                ...
                @if (!empty($projects))
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('project_id', 'تابعة لمشروع :') !!}
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa fa-user"></i>
                                </span>
                                {!! Form::select('project_id', $projects, $todo->project_id, [
                                    'class' => 'form-control select2',
                                    'required',
                                    'style' => 'width: 100%;',
