                    ...
                    <div class="tab-content">
                        @can('essentials.crud_all_attendance')
                            <div class="tab-pane active" id="shifts_tab">
                                <button type="button" class="btn button-add pull-right" data-toggle="modal"
                                ...
                                @can('essentials.crud_all_attendance')
                                    <div class="col-md-6 spacer">
                                        <button type="button" class="btn button-add btn-modal pull-right"
                                            data-href="{{ action('\Modules\Essentials\Http\Controllers\AttendanceController@create') }}"
...
@section('javascript')
    <script type="text/javascript">
        ...
        function get_attendance_summary() {
            ...
            $.ajax({
                url: '{{ action('\Modules\Essentials\Http\Controllers\AttendanceController@getUserAttendanceSummary') }}?user_id=' +
