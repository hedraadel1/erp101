...
class DataController extends Controller
{
    ...
    public function user_permissions()
    {
        return [
          [
            'value' => 'essentials.view_dashboard',
            'label' => __('essentials::lang.view_dashboard'),
            'default' => false
        ],
            [
            ...
            [
              'value' => 'essentials.enable_supervisor',
              'label' => 'عرض المشريفين',
              'default' => false
          ],
        ];
    ...
    */
    public function modifyAdminMenu()
    {
        ...
        $is_product_enabled = is_product_enabled('216');
        if($is_product_enabled){
          $module_util->assignPermissions($this->user_permissions());
         }
        if (($is_essentials_enabled || $is_product_enabled)  && auth()->user()->can('essentials.view_dashboard')) {
