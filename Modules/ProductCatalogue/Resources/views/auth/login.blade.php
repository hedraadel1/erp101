...
<button style="top: 0;position: fixed;" onclick="location.href='{{ route('demosys') }}'"
    class='button-30'>{{ __('business.Login_Demo') }} </button>

@section('content')
    <div class="background-wrap">
        <div class="background"></div>
    </div>
    <form method="POST" action="{{ route('product_catalogue.makelogin') }}" id="login-form">
...
<div class="brandloginfooter">
    <a class="button-86"
        href="{{ route('product_catalogue.register') }}@if (!empty(request()->lang)) {{ '?lang=' . request()->lang }} @endif">أضغط
        هنا للتسجيل</a>
</div>
@section('javascript')
