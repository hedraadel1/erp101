...
class DataController extends Controller
{
    ...
    public function modifyAdminMenu()
    {
        ...
        $is_product_enabled =   is_product_enabled('215');
       if($is_product_enabled){
        $module_util->assignPermissions($this->user_permissions());
       }
        if (($is_mfg_enabled || $is_product_enabled)&& (auth()->user()->can('manufacturing.access_recipe') || auth()->user()->can('manufacturing.access_production'))) {
