...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            'url' => action('\Modules\Manufacturing\Http\Controllers\RecipeController@store'),
            'method' => 'post',
            'id' => 'recipe_form',
        ]) !!}
        <div id="box_group">
            <div class="box box-solid">
                <div class="box-header">
                    <h4 class="box-title"><strong>@lang('sale.product'): </strong>{{ $variation->product_name }} @if ($variation->product_type == 'variable')
                                    ...
                                    @if (!empty($ingredients))
                                        @foreach ($ingredients as $ingredient)
                                            ...
                                            @if (empty($ingredient['mfg_ingredient_group_id']))
                                                ...
                                                @include('manufacturing::recipe.ingredient_row', [
            ...
            @foreach ($ingredient_groups as $ingredient_group)
                ...
                @endphp
                @include('manufacturing::recipe.ingredient_group', [
        ...
        <div class="box box-solid">
            <div class="box-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {!! Form::text('waste_percent', !empty($recipe->waste_percent) ? @num_format($recipe->waste_percent) : 0, [
                                    'class' => 'form-control input_number',
                                    'placeholder' => __('manufacturing::lang.wastage'),
                                ]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="@if (!is_array($unit_html)) input-group @else input_inline @endif">
                                {!! Form::text(
                                    'total_quantity',
                                    !empty($recipe->total_quantity) ? @format_quantity($recipe->total_quantity) : 1,
                                    ['class' => 'form-control input_number', 'placeholder' => __('manufacturing::lang.total_output_quantity')],
                                ) !!}
                                        ...
                                        <select name="sub_unit_id" class="form-control" id="sub_unit_id">
                                            @foreach ($unit_html as $key => $value)
                                                <option value="{{ $key }}"
                                                    ...
                                                    @if (!empty($recipe->sub_unit_id) && $recipe->sub_unit_id == $key) selected @endif>{{ $value['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                    @else
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input_inline">
                                {!! Form::text('extra_cost', !empty($recipe->extra_cost) ? @num_format($recipe->extra_cost) : 0, [
                                    'class' => 'form-control input_number',
                                    'placeholder' => __('manufacturing::lang.extra_cost'),
                                ]) !!}
                                <span>
                                    {!! Form::select(
                                        ...
                                        !empty($recipe->production_cost_type) ? $recipe->production_cost_type : 'fixed',
                                        ['class' => 'form-control', 'id' => 'production_cost_type'],
                                    ) !!}
                                </span>
                            </div>
                            <p><strong>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('instructions', !empty($recipe) ? $recipe->instructions : null, [
                                'class' => 'form-control',
                                'placeholder' => __('manufacturing::lang.recipe_instructions'),
                            ]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="submit" class="btn button-29 pull-right">@lang('messages.save')</button>
                    </div>
                </div>
            </div>
        </div>
