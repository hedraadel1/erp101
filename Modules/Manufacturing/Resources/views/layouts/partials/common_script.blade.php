<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#production_list_filter_date_range').daterangepicker(
            dateRangeSettings,
            function(start, end) {
                $('#production_list_filter_date_range').val(start.format(moment_date_format) + ' ~ ' + end
            ...
            ajax: {
                ...
                "data": function(d) {
                    if ($('#production_list_filter_date_range').val()) {
                        var start = $('#production_list_filter_date_range').data('daterangepicker')
                            .startDate.format('YYYY-MM-DD');
                        var end = $('#production_list_filter_date_range').data('daterangepicker')
        ...
        $(document).on('change', '#production_list_filter_date_range, #productstion_list_filter_location_id',
            function() {
                productions_table.ajax.reload();
            });
    ...
    function addIngredientRow(variation_id, search_element) {
        ...
        $.ajax({
            url: "/manufacturing/get-ingredient-row/" + variation_id + '?row_index=' + row_index +
                '&row_ig_index=' + row_ig_index + '&sort_order=' + sort_order,
            dataType: 'html',
