...
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => action('\Modules\Manufacturing\Http\Controllers\ProductionController@update', [$production_purchase->id]),
            'method' => 'put',
            'id' => 'production_form',
            'files' => true,
        ]) !!}
        ...
        @component('components.widget', ['class' => 'box-solid', 'title' => __('manufacturing::lang.ingredients')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn button-29 pull-right">@lang('messages.submit')</button>
                </div>
            </div>
        @endcomponent
