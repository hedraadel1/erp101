        ...
        <section class="content">
            @component('components.widget', ['class' => 'box-solid', 'title' => __('connector::lang.clients')])
                @slot('tool')
                    <div class="box-tools">
                        @can('superadmin')
                            <a href="{{ action('\Modules\Connector\Http\Controllers\ClientController@regenerate') }}"
                        ...
                        <tbody>
                            @foreach ($clients as $client)
                                <tr>
                                    ...
                                    <td>{{ $client->secret }}</td>
                                    <td>{!! Form::open([
                                        'url' => action('\Modules\Connector\Http\Controllers\ClientController@destroy', [$client->id]),
                                        'method' => 'delete',
    ...
    <div class="modal fade" id="create_client_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {!! Form::open([
                    'url' => action('\Modules\Connector\Http\Controllers\ClientController@store'),
                    'method' => 'post',
                    'id' => 'create_client_form',
                ]) !!}
