...
class DataController extends Controller
{
    ...
    */
    ...
    public function modifyAdminMenu()
    {
        ...
        $is_product_enabled =  is_product_enabled('227');
        ...
        if (($is_asset_enabled || $is_product_enabled)&& (auth()->user()->can('superadmin') || auth()->user()->can('asset.view') || auth()->user()->can('asset.view_own_maintenance') || auth()->user()->can('asset.view_all_maintenance') )) {
