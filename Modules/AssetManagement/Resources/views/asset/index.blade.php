...
@section('content')
    ...
    <section style="margin-top: -25px;" class="content-header">
        <div class="newbox blackline">
            <h3 style="margin-top: 10px;margin-bottom: 10px;">@lang('assetmanagement::lang.assets')</h3>
        </div>
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-3">
                ...
                {!! Form::select('asset_list_filter_category_id', $asset_category, null, [
                    'class' => 'form-control select2',
                    'placeholder' => __('lang_v1.all'),
                    'style' => 'width: 100%;',
                ]) !!}
            ...
            <div class="col-md-3">
                ...
                {!! Form::select('asset_list_filter_purchase_type', $purchase_types, null, [
                    'class' => 'form-control select2',
                    'placeholder' => __('lang_v1.all'),
                    'style' => 'width: 100%;',
                ]) !!}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="asset_list_filter_allocatable" value="1" class="input-icheck"
                                id="asset_list_filter_allocatable">
        ...
        @endcomponent
        @component('components.widget', ['title' => __('assetmanagement::lang.all_assets')])
            @slot('tool')
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-tools ">
                            <a type="button" class="btn btn-sm button-add"
                                data-href="{{ action('\Modules\AssetManagement\Http\Controllers\AssetController@create') }}"
                                id="add_asset">
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',
                '#asset_list_filter_location_id, #asset_list_filter_category_id, #asset_list_filter_purchase_type',
                function() {
