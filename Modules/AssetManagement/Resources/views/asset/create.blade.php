...
<div class="modal-dialog modal-lg" role="document">
    {!! Form::open([
        'action' => '\Modules\AssetManagement\Http\Controllers\AssetController@store',
        'id' => 'asset_form',
        'method' => 'post',
        'files' => true,
    ]) !!}
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('asset_code', null, [
                            'class' => 'form-control',
                            'placeholder' => __('assetmanagement::lang.asset_code'),
                        ]) !!}
                        <p class="help-block">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('name', null, [
                            'class' => 'form-control',
                            'placeholder' => __('assetmanagement::lang.asset_name'),
                            'required',
                        ]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    {!! Form::text('model', null, [
                        'class' => 'form-control',
                        'placeholder' => __('assetmanagement::lang.model_no'),
                    ]) !!}
                </div>
                <div class="col-md-4">
                    ...
                    {!! Form::text('serial_no', null, [
                        'class' => 'form-control',
                        'placeholder' => __('assetmanagement::lang.serial_no'),
                    ]) !!}
                </div>
                <div class="clearfix"></div>
                <div class="col-md-4">
                    {!! Form::label('category_id', __('assetmanagement::lang.asset_category') . ':') !!}
                    {!! Form::select('category_id', $asset_category, null, [
                        'class' => 'form-control',
                        'placeholder' => __('messages.please_select'),
                        'required',
                        'style' => 'width: 100%;',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('purchase_date', null, [
                            ...
                            'placeholder' => __('purchase.purchase_date'),
                            'readonly',
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    {!! Form::select('purchase_type', $purchase_types, null, [
                        'class' => 'form-control',
                        'placeholder' => __('messages.please_select'),
                        'style' => 'width: 100%;',
                    ]) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('unit_price', null, [
                            'class' => 'form-control input_number',
                            'placeholder' => __('sale.unit_price'),
                            'required',
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('depreciation', null, [
                            'class' => 'form-control input_number',
                            'placeholder' => __('assetmanagement::lang.depreciation'),
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button type="button" class="btn btn-primary btn-sm pull-right" id="add_more_warranty"><i
                            class="fas fa-plus"></i> @lang('assetmanagement::lang.add_more')</button>
                </div>
                <div class="col-md-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! Form::text('months[]', null, [
                                        'class' => 'form-control input_number',
                                        'placeholder' => __('assetmanagement::lang.warranty_months'),
                                    ]) !!}
                                </td>
                                <td>
                                    {!! Form::text('additional_cost[]', 0, [
                                        'class' => 'form-control input_number',
                                        'placeholder' => __('assetmanagement::lang.additional_cost'),
                                    ]) !!}
                                </td>
                                <td>
                                    {!! Form::textarea('additional_note[]', null, [
                                        'class' => 'form-control',
                                        'placeholder' => __('purchase.additional_notes'),
                                        'rows' => 3,
                                    ]) !!}
                                </td>
                                <td>&nbsp;</td>
        ...
        <div class="modal-footer">
            <div class="row">
                <div class="col-md-6">
                    <button type="button" class="btn btn-default button-30" data-dismiss="modal">
                        @lang('messages.close')
                    </button>
                </div>

                <div class="col-md-6">
                    <button type="submit" class="btn button-29">
                        @lang('messages.save')
                    </button>
                </div>
            </div>
