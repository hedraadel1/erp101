...
@section('content')
    ...
    <section style="margin-top: -25px;" class="content-header">
        <div class="newbox blackline">
            <h3 style="margin-top: 10px;margin-bottom: 10px;">@lang('assetmanagement::lang.asset_allocated')</h3>
        </div>

    </section>
    <!-- Main content -->
    <section class="content no-print">
        @component('components.widget', ['title' => __('assetmanagement::lang.asset_allocated')])
            @slot('tool')
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-tools ">
                            <a class="btn btn-sm button-add" id="allocate_asset"
                                data-href="{{ action('\Modules\AssetManagement\Http\Controllers\AssetAllocationController@create') }}">
        ...
        {{-- <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    <a class="btn btn-sm btn-primary" id="allocate_asset"
                        data-href="{{ action('\Modules\AssetManagement\Http\Controllers\AssetAllocationController@create') }}">
                        <i class="fa fa-plus"></i>
                        @lang('messages.add')
                    </a>
        ...
        $(document).ready(function() {
            assest_allocated_datatable = $("#assest_allocated_table").DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'ref_no',
                        name: 'asset_transactions.ref_no'
                    },
                    {
                        data: 'receiver_name',
                        name: 'receiver_name'
                    ...
                    {
                        data: 'quantity',
                        name: 'asset_transactions.quantity'
                    },
                    {
                    ...
                    {
                        data: 'allocated_at',
                        name: 'asset_transactions.transaction_datetime'
                    },
                    {
                        data: 'allocated_upto',
                        name: 'asset_transactions.allocated_upto'
                    },
                    {
                        data: 'provider_name',
                        name: 'provider_name'
                    ...
                    {
                        data: 'reason',
                        name: 'asset_transactions.reason'
                    },
                ]
            });
