<div class="modal-dialog" role="document">
    {!! Form::open([
        'url' => action('\Modules\AssetManagement\Http\Controllers\AssetAllocationController@update', [
            $asset_allocated->id,
        ]),
        'method' => 'put',
        'id' => 'asset_allocation_form',
    ]) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('receiver', $users, $asset_allocated->receiver, [
                            'class' => 'form-control select2',
                            'placeholder' => __('messages.please_select'),
                            'required',
                            'style' => 'width: 100%;',
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text(
                            'quantity',
                            !empty($asset_allocated->quantity) ? @format_quantity($asset_allocated->quantity) : null,
                            [
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text(
                            ...
                            !empty($asset_allocated->transaction_datetime) ? @format_datetime($asset_allocated->transaction_datetime) : null,
                            [
                                'class' => 'form-control datetimepicker',
                                'placeholder' => __('assetmanagement::lang.allocate_from'),
                                'readonly',
                                'required',
                            ],
                        ) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text(
                            'allocated_upto',
                            !empty($asset_allocated->allocated_upto) ? @format_date($asset_allocated->allocated_upto) : null,
                            ['class' => 'form-control datepicker', 'placeholder' => __('assetmanagement::lang.allocated_upto'), 'readonly'],
                        ) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('reason', $asset_allocated->reason, [
                            'class' => 'form-control',
                            'rows' => '3',
                            'placeholder' => __('assetmanagement::lang.reason'),
                        ]) !!}
                    </div>
                </div>
            </div>
