<div class="modal-dialog" role="document">
    {!! Form::open([
        'action' => '\Modules\AssetManagement\Http\Controllers\AssetAllocationController@store',
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('ref_no', null, [
                            'class' => 'form-control',
                            'placeholder' => __('assetmanagement::lang.allocation_code'),
                        ]) !!}
                        <p class="help-block">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('receiver', $users, null, [
                            'class' => 'form-control select2',
                            'placeholder' => __('messages.please_select'),
                            'required',
                            'style' => 'width: 100%;',
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('transaction_datetime', null, [
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('allocated_upto', null, [
                            'class' => 'form-control datepicker',
                            'placeholder' => __('assetmanagement::lang.allocated_upto'),
                            'readonly',
                        ]) !!}
                    </div>
                </div>
