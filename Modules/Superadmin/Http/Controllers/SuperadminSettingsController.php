...
class SuperadminSettingsController extends BaseController
{
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            //Checkboxes
            $checkboxes = ['enable_business_based_username', 'enable_view_brand_store', 'superadmin_enable_register_tc', 'allow_email_settings_to_businesses', 'enable_new_business_registration_notification', 'enable_new_subscription_notification', 'enable_welcome_email', 'enable_offline_payment'];
            $input = $request->input();
