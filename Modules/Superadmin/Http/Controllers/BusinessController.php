                ...
                ->addColumn('action', function($row) {
                    ...
                    $html = '<a href="' .
                            action("\Modules\Superadmin\Http\Controllers\BusinessController@show", [$row->id]) . '"
                                class="btn btn-info Btn-Brand btn-xs">' . __('superadmin::lang.manage' ) . '</a>
                            <button type="button" class="btn btn-xs Btn-Brand Btn-Primary btn-modal" data-href="' . action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@create', ['business_id' => $row->id]) . '" data-container=".view_modal">'
                                  . __('superadmin::lang.add_subscription' ) . '</button>
                            <button type="button" class="btn btn-xs Btn-Brand Btn-Primary btn-modal" data-href="' . action('\Modules\Superadmin\Http\Controllers\WalletController@create', ['business_id' => $row->id]) . '" data-container=".view_modal">'
                                  . __('superadmin::lang.add_amount' ) . '</button>
                            <button type="button" class="btn btn-xs Btn-Brand Btn-Primary btn-modal" data-href="' . action('\Modules\Superadmin\Http\Controllers\WalletController@create', ['business_id' => $row->id , 'type'=>'free']) . '" data-container=".view_modal">'
                                  . __('superadmin::lang.cash_back' ) . '</button>
                            <button type="button" class="btn btn-xs Btn-Brand Btn-Primary btn-modal" data-href="' . action('\Modules\Superadmin\Http\Controllers\SuperadminProductController@shortCreate', ['business_id' => $row->id]) . '" data-container=".view_modal">'
                                  . __('superadmin::lang.add_product' ) . '</button>
                            <a class="btn btn-xs Btn-Brand Btn-Primary " href="' . action('\Modules\Superadmin\Http\Controllers\SuperadminProductController@showBusinessProduct' ,$row->id) . '" >'
                                  . 'المنتجات '. '</a>';

                            if($row->is_active == 1) {
                                $html .= ' <a href="' . action('\Modules\Superadmin\Http\Controllers\BusinessController@toggleActive', [$row->id, 0]) . '"
                                    class="btn btn-danger btn-xs Btn-Brand link_confirmation">' . __('lang_v1.deactivate') . '
                                </a>';
                            } else {
                                $html .= ' <a href="' . action('\Modules\Superadmin\Http\Controllers\BusinessController@toggleActive', [$row->id, 1]) . '"
                                    class="btn btn-success btn-xs Btn-Brand link_confirmation">' . __('lang_v1.activate' ) . '
                                </a>';
                            }
							if($row->is_old == 1) {
