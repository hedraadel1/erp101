...
class SubscriptionController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin::subscription.index')
            ->with(compact('wallet','packages', 'active', 'nexts', 'waiting', 'permission_formatted', 'intervals'));
    }
    ...
    public function confirm($package_id, Request $request)
    {
        ...
        try {
            ...
            $subscription = $this->_add_subscription($business_id, $package_id, request()->gateway, $payment_transaction_id, $user_id);
