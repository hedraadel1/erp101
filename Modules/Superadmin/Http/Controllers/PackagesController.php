...
class PackagesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['name', 'description', 'location_count','warehouse_count','sleep_page_time', 'sup_warehouse','sell_from_loation_main_store','sell_from_store', 'user_count', 'product_count', 'invoice_count', 'interval', 'interval_count', 'trial_days', 'price', 'sort_order', 'is_active', 'custom_permissions', 'is_private', 'is_one_time','enable_installment', 'enable_custom_link', 'custom_link',
                'custom_link_text','enable_invoice_url','enable_invoice_url_in_prient','enable_qr_in_prient','enable_notice_forms','']);
            ...
            $input['enable_installment'] = empty($input['enable_installment']) ? 0 : 1;
            $input['enable_invoice_url'] = empty($input['enable_invoice_url']) ? 0 : 1;
            $input['enable_invoice_url_in_prient'] = empty($input['enable_invoice_url_in_prient']) ? 0 : 1;
            $input['enable_qr_in_prient'] = empty($input['enable_qr_in_prient']) ? 0 : 1;
            $input['enable_notice_forms'] = empty($input['enable_notice_forms']) ? 0 : 1;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $packages_details = $request->only(['name', 'id', 'description', 'location_count','warehouse_count','sleep_page_time','sup_warehouse','sell_from_loation_main_store','sell_from_store', 'user_count', 'product_count', 'invoice_count', 'interval', 'interval_count', 'trial_days', 'price', 'sort_order', 'is_active', 'custom_permissions', 'is_private', 'is_one_time','enable_installment', 'enable_custom_link', 'custom_link', 'custom_link_text' ,'enable_invoice_url','enable_invoice_url_in_prient','enable_qr_in_prient','enable_notice_forms']);
            ...
            $packages_details['enable_installment'] = empty($packages_details['enable_installment']) ? 0 : 1;
            $packages_details['enable_invoice_url'] = empty($packages_details['enable_invoice_url']) ? 0 : 1;
            $packages_details['enable_invoice_url_in_prient'] = empty($packages_details['enable_invoice_url_in_prient']) ? 0 : 1;
            $packages_details['enable_qr_in_prient'] = empty($packages_details['enable_installment']) ? 0 : 1;
            $packages_details['enable_notice_forms'] = empty($packages_details['enable_installment']) ? 0 : 1;
