                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::number('warehouse_count', null, ['class' => 'form-control', 'required', 'min' => 0]) !!}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::number('sup_warehouse', null, ['class' => 'form-control', 'required', 'min' => 0]) !!}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                ...
                                {!! Form::text('sleep_page_time', null, ['class' => 'form-control input_number', 'required']) !!}
                                <span class="help-block">
                    ...
                    <div class="col-sm-4">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('enable_installment', 1, false, ['class' => 'input-icheck', 'id' => 'enable_installment']) !!}
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('enable_invoice_url', 1, false, ['class' => 'input-icheck', 'id' => 'enable_invoice_url']) !!}
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('enable_invoice_url_in_prient', 1, false, [
                                    'class' => 'input-icheck',
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('enable_qr_in_prient', 1, false, [
                                    'class' => 'input-icheck',
                    ...
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('enable_notice_forms', 1, false, [
                                    'class' => 'input-icheck',
                    ...
                    <div class="col-sm-4">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('sell_from_loation_main_store', 1, false, [
                                    'class' => 'input-icheck',
                    ...
                    <div class="col-sm-4">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('sell_from_store', 1, false, [
                                    'class' => 'input-icheck',
                                    'id' => 'sell_from_store',
                                ]) !!}
