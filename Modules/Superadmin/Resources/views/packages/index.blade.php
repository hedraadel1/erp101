                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box box-success hvr-grow-shadow">
                            ...
                            <div class="box-body text-center">
                                ...
                                <br />
                                @if ($package->warehouse_count == 0)
                                    @lang('superadmin::lang.unlimited')
                                @else
                                    {{ $package->warehouse_count }}
                                @endif
                                @lang('business.warehouses')
                                <br />
                                @if ($package->sup_warehouse == 0)
                                    @lang('superadmin::lang.unlimited')
                                @else
                                    {{ $package->sup_warehouse }}
                                @endif
                                @lang('business.sup_warehouses')
                                <br />
                                @if ($package->enable_installment == 1)
                                    @lang('superadmin::lang.enable_installment')
                                    <br />
                                @endif
                                @if ($package->enable_invoice_url == 1)
                                    @lang('superadmin::lang.enable_invoice_url')
                                    <br />
                                @endif
                                @if ($package->enable_invoice_url_in_prient == 1)
                                    @lang('superadmin::lang.enable_invoice_url_in_prient')
                                    <br />
                                @endif
                                @if ($package->enable_qr_in_prient == 1)
                                    @lang('superadmin::lang.enable_qr_in_prient')
                                    <br />
                                @endif
                                @if ($package->sell_from_loation_main_store == 1)
                                    @lang('superadmin::lang.sell_from_loation_main_store')
                                    <br />
                                @endif
                                @if ($package->sell_from_store == 1)
                                    @lang('superadmin::lang.sell_from_store')
                                    <br />
                                @endif
                                @if ($package->enable_notice_forms == 1)
                                    @lang('superadmin::lang.enable_notice_forms')
                                    <br />
                                @endif
