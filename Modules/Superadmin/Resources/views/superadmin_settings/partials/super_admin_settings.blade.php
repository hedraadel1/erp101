    ...
    <div class="row">
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('invoice_business_name', $settings['invoice_business_name'], [
                        'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('app_currency_id', $currencies, $settings['app_currency_id'], [
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('invoice_business_landmark', $settings['invoice_business_landmark'], [
                        'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('invoice_business_zip', $settings['invoice_business_zip'], [
                        'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('invoice_business_state', $settings['invoice_business_state'], [
                        'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('invoice_business_city', $settings['invoice_business_city'], [
                        'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('invoice_business_country', $settings['invoice_business_country'], [
                        'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('package_expiry_alert_days', $settings['package_expiry_alert_days'], [
                        'class' => 'form-control',
                        'placeholder' => __('superadmin::lang.package_expiry_alert_days'),
                        'required',
                    ]) !!}
                </div>
            </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                <label>
                    {!! Form::checkbox(
                        'enable_view_brand_store',
                        1,
                        isset($settings['enable_view_brand_store']) ? (int) $settings['enable_view_brand_store'] : false,
                        [
                            'class' => 'input-icheck',
                        ],
                    ) !!} {{ __('superadmin::lang.enable_view_brand_store') }}
                </label>
                <p class="help-block">@lang('superadmin::lang.enable_view_brand_store')</p>
            </div>
        </div>
