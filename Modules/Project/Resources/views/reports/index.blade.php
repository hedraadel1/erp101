        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-solid">
                    ...
                    <div class="box-footer text-center">
                        <a href="{{ action('\Modules\Project\Http\Controllers\ReportController@getEmployeeTimeLogReport') }}"
            ...
            <div class="col-md-4">
                <div class="box box-solid">
                    ...
                    <div class="box-footer text-center">
                        <a href="{{ action('\Modules\Project\Http\Controllers\ReportController@getProjectTimeLogReport') }}"
                            class="btn btn-block bg-navy btn-flat">
                            <i class="fa fa-eye"></i>
                            @lang('messages.view')
                        </a>
