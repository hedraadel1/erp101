...
@section('content')
    ...
    <section style="margin-top: -25px;" class="content-header">
        <div class="newbox blackline">
            <h3 style="margin-top: 10px;margin-bottom: 10px;">@lang('user.edit_user')</h3>
        </div>
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @component('components.widget', ['title' => __('lang_v1.roles_and_permissions')])
                        ...
                        @if (is_product_enabled('239'))
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('is_supervisor', 1, !empty($user->is_supervisor), [
                                                'class' => 'input-icheck',
                                                'id' => 'is_supervisor',
                                            ]) !!} {{ __('lang_v1.is_supervisor') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                        <input type="checkbox" name="is_agent" value="1"
                                            {{ $user->isAgent() ? 'checked' : '' }} class="input-icheck "
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="submit" class="button-29" id="submit_user_button">@lang('messages.update')</button>
                </div>
            </div>
            {!! Form::close() !!}
        @stop
