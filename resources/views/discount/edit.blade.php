<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('DiscountController@update', [$discount->id]),
            'method' => 'put',
            'id' => 'discount_form',
        ]) !!}
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="spg" class="form-control">
                            <option value="" @if (is_null($discount->spg)) selected @endif>@lang('lang_v1.all')
                            </option>
                            @foreach ($price_groups as $k => $v)
                                <option value="{{ $k }}" @if ($discount->spg === (string) $k) selected @endif>
                                    {{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="modal-footer">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <button type="button" class="btn  btn-block Btn-Brand Btn-bx button-30"
