...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('lang_v1.product_sell_report')
            </h3>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.filters', ['title' => __('report.filters')])
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('ir_user_id', __('report.user') . ':') !!}
                            {!! Form::select('ir_user_id', $users, null, [
