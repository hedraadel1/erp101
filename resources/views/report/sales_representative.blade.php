...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('report.sales_representative')
            </h3>
        </div>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        @if (is_product_enabled('257'))
                            <li>
                                <a href="#sr_customer_group_commission_tab" data-toggle="tab" aria-expanded="true"><i
                                        class="fa fa-cog" aria-hidden="true"></i> عمولة بناء علي مجموعة العملاء</a>
                            </li>
                        @endif
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="sr_customer_group_commission_tab">
                            @include('report.partials.sales_customer_group_commission')
                        </div>
