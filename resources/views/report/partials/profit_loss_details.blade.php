<div class="col-xs-12 col-md-6">
    @component('components.widget')
        <table class="table table-striped">
            ...
            <tr>
                <th>{{ __('home.total_purchase') }}:<br><small class="text-muted">(@lang('product.exc_of_tax'),
                        @lang('sale.discount'))</small></th>
                <td>
    ...
    @component('components.widget')
        ...
        <small class="help-block">@lang('lang_v1.gross_profit') + (@lang('lang_v1.total_sell_shipping_charge') + @lang('lang_v1.sell_additional_expense') + @lang('report.total_stock_recovered') +
            ...
            @foreach ($data['right_side_module_data'] as $module_data)
                ...
                @endif
            @endforeach
            ) <br> - ( @lang('report.total_stock_adjustment') + @lang('report.total_expense') + @lang('lang_v1.total_purchase_shipping_charge') + @lang('lang_v1.total_transfer_shipping_charge') +
