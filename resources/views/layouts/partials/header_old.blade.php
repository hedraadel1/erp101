                    ...
                    <div class="col-sm-6">
                        ...
                        <ul style="padding-top: 7px;">
                            <li title="@lang('lang_v1.dock_products')" style="margin-right: 2px;margin-left: 2px;">
                                ...
                                <a style="float: unset !important;display: unset !important;" class="sidebar-toggle"
                            ...
                            <li style="margin-right: 2px;margin-left: 2px;" class="dropdown notifications-menu">
                                ...
                                <ul style="right: initial !important" class="dropdown-menu">
                                    <!-- <li class="header">You have 10 unread notifications</li> -->
                                    <li>
                                        <!-- inner menu: contains the actual data -->
                                        <ul style="width: 250px;padding: 10px;" class="" id="notifications_list">
