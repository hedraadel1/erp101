...
<div style="margin-right: unset;border-radius: 25px;  background: linear-gradient(to right, #232526, #414345);padding-right: 10px;padding-left: 10px;margin-bottom: unset;"
    ...
    <div class=" no-print pos-header">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="m-6 mt-5" style="display: flex; {{ $is_mobile ? 'margin-bottom: -20px;' : '' }}">
                    <p><strong>@lang('sale.location'): &nbsp;</strong>
                        ...
                        <input
                            style="width: 160px;display:unset !important;height: 24px;font-weight: 700;border-radius: 5px;"
                            type="text" class="form-control" placeholder="@lang('sale.invoice_no')"
                            id="send_for_sell_return_invoice_no">
                            <button style="width: 100px;height: 24px;margin-right: 4px;padding:unset !important"
                            type="button" class="btn btn-danger" id="send_for_sell_return">@lang('lang_v1.send')</button>
                       <button style="width: 100px;height: 24px;margin-right: 4px;padding:unset !important" type="button"
                            class="btn btn-danger" id="send_for_sell_replace">@lang('lang_v1.reblace')</button>
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                @endcan
                {{-- <a href="#" class="matbutton darkblue"><i style="color: white;"
                        class="fa-regular  fa-rectangle-xmark fa-xl"></i></a> --}}

                {{-- <div class="dropdown"> --}}
                <button title="@lang('lang_v1.filter')" id="btnfilter"
                    class="btn btn-success btn-flat pull-right m-5 btn-xs mt-10 popover-default dropdown-toggle"
                    type="button">
                    <strong><i class="fa fa-filter fa-lg" aria-hidden="true"></i></strong>
                </button>
