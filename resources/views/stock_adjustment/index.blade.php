...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('stock_adjustment.stock_adjustments')
            </h3>
        </div>
    </section>
    ...
    <section class="content">
        @component('components.widget', [
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="box-tools">
                    <a class="btn btn-block button-add" href="{{ action('StockAdjustmentController@create') }}">
