...
@section('content')
    ...
    <section style="margin-top: -25px;" class="content-header">
        <div class="newbox orange">
            <h3 style="margin-top: 10px;margin-bottom: 10px;">@lang('expense.add_expense')</h3>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        @if (is_product_enabled('252'))
                            <label>
                                {!! Form::checkbox('is_recur', 1, false, ['class' => 'input-icheck', 'id' => 'is_recur']) !!} @lang('lang_v1.is_recur')?
                            </label>
                        @endif
