...
@section('content')
    ...
    <section style="margin-top: -25px;" class="content-header">
        <div class="newbox orange">
            <h3 style="margin-top: 10px;margin-bottom: 10px;">@lang('expense.edit_expense')</h3>
        </div>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <label>
                            {!! Form::checkbox('is_refund', 1, $expense->type == 'expense_refund' ? 'checked' : null, [
                                'class' => 'input-icheck',
                                'id' => 'is_refund',
                            ]) !!} @lang('lang_v1.is_refund')?
                        </label>@show_tooltip(__('lang_v1.is_refund_help'))
                        <br>
                        @if (is_product_enabled('252'))
                          <label>
                            {!! Form::checkbox('is_recur', 1, $expense->is_recur, ['class' => 'input-icheck', 'id' => 'is_recur']) !!} @lang('lang_v1.is_recur')?
                          </label>   
                            @endif  
                       
                        {{-- <div id="showrecur" role="button" class="button-84">@lang('messages.save')</div> --}}
                    </div>
                </div>
            </div>
        </div>
    ...
    'title' => __('purchase.add_payment'),
        ...
        <div class="col-sm-12 text-center">
            <button type="submit" class="btn button-29 btn-big">@lang('messages.save')</button>
        </div>
...
@section('javascript')
    <script type="text/javascript">
        ...
        $('#is_recur').on('ifChecked', function(event) {
            $('#recur_expense_div').css({
                'display': 'inline-flex',

            });
        });
        $('#is_recur').on('ifUnchecked', function(event) {
            $('#recur_expense_div').css({
                'display': 'none',
