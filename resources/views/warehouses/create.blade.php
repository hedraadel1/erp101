<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('WarehouseController@store'),
            'method' => 'post',
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('business.add_warehouse')</h4>
        </div>
            ...
            <div class="row">
                ...
                <div style="margin-right:50px" class="form-group">
                    <div class="checkbox">
                        ...
                        <input class="input-icheck" name="is_sup_warehouse" type="checkbox" value="1">
                        مخزن فرعي
