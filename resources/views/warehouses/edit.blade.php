<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('WarehouseController@update', [$location->id]),
            'method' => 'PUT',
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('business.edit_warehouse')</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('location_id', __('business.warehouse_id') . ':') !!}
                        {!! Form::text('location_id', $location->location_id, [
                            'class' => 'form-control',
                            'placeholder' => __('business.warehouse_id'),
                        ]) !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('business_location_id', __('business.select_business_location') . ':*') !!} @show_tooltip(__('lang_v1.invoice_layout_for_sale_tooltip'))
                        {!! Form::select('business_location_id', $business_locations, $location->business_location_id, [
                            'class' => 'form-control',
                            'required',
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <select name="warehouse_category_id" class="form-control select2" id="">
                            <option value="">{{ __('messages.please_select') }}</option>
                            @foreach ($warehouse_categories as $key => $value)
                                <option {{ $location->warehouse_category_id == $key ? 'selected' : '' }}
                ...
                <div style="margin-right:50px" class="form-group">
                    <div class="checkbox">
                        ...
                        <input class="input-icheck" name="is_sup_warehouse"
                            {{ $location->is_sup_warehouse == 1 ? 'checked' : '' }} type="checkbox" value="1">
                        مخزن فرعي
