...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('lang_v1.edit_stock_transfer')
            </h3>
        </div>
    </section>
    ...
    <section class="content no-print">
        {!! Form::open([
            'url' => action('StockTransferController@update', [$sell_transfer->id]),
            'method' => 'put',
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('transaction_date', @format_datetime($sell_transfer->transaction_date), [
                                    'class' => 'form-control',
                                    'readonly',
                                    'required',
                                ]) !!}
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            @if (auth()->user()->can('purchase.stock_update_status'))
                                {!! Form::select('status', $statuses, $sell_transfer->status, [
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_charges', @num_format($sell_transfer->shipping_charges), [
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <input type="hidden" id="total_amount" name="final_total"
                            value="{{ $sell_transfer->final_total }}">
                    ...
                    <div class="col-sm-12">
                        <button type="submit" id="save_stock_transfer"
                            class="btn button-29 pull-right">@lang('messages.save')</button>
                    </div>
                </div>
