<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('Restaurant\ModifierSetsController@update', [$modifer_set->id]),
            'method' => 'PUT',
            'id' => 'edit_form',
        ]) !!}
                            ...
                            @foreach ($modifer_set->variations as $modifier)
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" name="modifier_name_edit[{{ $modifier->id }}]"
                                                ...
                                                placeholder="@lang('lang_v1.name')" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <button class="btn btn-primary btn-xs pull-right add-modifier-row"
                                                type="button" data-html="{{ $html }}">
