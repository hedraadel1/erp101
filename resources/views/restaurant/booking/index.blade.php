...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('restaurant.bookings')
            </h3>
        </div>
    </section>
            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    ...
                    <div class=" table-responsive">
                        <table style="left: 55px !important" class="table table-bordered table-condensed"
                            id="todays_bookings_table">
                            <thead>
                                <tr>
