<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('Category2Controller@update', [$category2->id]),
            'method' => 'PUT',
            'id' => 'category2_edit_form',
        ]) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">@lang('category.edit_category') 2</h4>
        </div>

        <div class="modal-body">
            <div class="form-group">
                {!! Form::label('name', __('category.category_name') . ':*') !!}
                {!! Form::text('name', $category2->name, [
                    'class' => 'form-control',
                    'required',
            ...
            <div class="form-group">
                ...
                {!! Form::text('description', $category2->description, [
                    'class' => 'form-control',
