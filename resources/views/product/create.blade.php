...
@section('content')
    ...
    <section class="content">
                ...
                <div class="btngroupproduct-group">
                    ...
                    <div class="col-sm-3">
                        @can('product.opening_stock')
                            <button value="submit_n_add_opening_stock" id="opening_stock_button"
                                ...
                                class="btngroupproduct submit_product_form btngroupproduct-lg btn-green">@lang('lang_v1.save_n_add_opening_stock')</button>
                        @endcan
                    </div>

                    <div class="col-sm-3">
                        <button type="submit" value="save_n_add_another"
                            class="btngroupproduct submit_product_form btngroupproduct-lg btn-blue">@lang('lang_v1.save_n_add_another')</button>
                    ...
                    <div class="col-sm-3">
                        <button type="submit" value="submit"
                            class="btngroupproduct btngroupproduct-lg submit_product_form btngroupproduct-light">@lang('messages.save')</button>
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('product.add_new_product')])
            <div class="row">
                <div class="col-sm-4">
        ...
        <div class="w3-container">
            ...
            <div id="Basic_info" class="w3-container w3-border city">
                ...
                <div class="row boxcontain">
                    ...
                    <div class="col-sm-4 @if (session('business.enable_category2') == 0) hide @endif">
                        <div class="form-group">
                            ...
                            {!! Form::select(
                                'category2_id',
                                $categorys2,
                                !empty($duplicate_product->category2_id) ? $duplicate_product->category2_id : null,
                                ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2'],
                            ) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('product_locations', __('business.business_locations_warehouse') . ':') !!} @show_tooltip(__('lang_v1.product_location_help'))
        ...
        <div id="addon_info" class="w3-container w3-border city" style="display:none">
            ...
            <div class="row boxcontain">
                        ...
                        <div class="form-group">
                            <div class="multi-input">
                                ...
                                {!! Form::select(
                                    ...
                                    ['class' => 'form-control select2 pull-left', 'style' => 'width:100%;', 'id' => 'expiry_period_type'],
                                ) !!}
                            </div>
                        </div>
                    </div>
                ...
                {{-- {{ dd($common_settings['enable_product_warranty']) }} --}}
        ...
        <div id="price_info" class="w3-container w3-border city" style="display:none">
            ...
            <div class="row boxcontain">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('type', $product_types, !empty($duplicate_product->type) ? $duplicate_product->type : null, [
                            'class' => 'form-control select2 selectwidth',
                            'required',
                ...
                <div class="col-sm-3 @if (!session('business.enable_price_tax')) hide @endif">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            ...
                            ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2 selectwidth'],
                            $tax_attributes,
                        ) !!}
                    </div>
                </div>
                ...
                <button style="width:100%" id="show_discount_table" type="button"
                    class="btn btn-info">{{ __('product.product_price_discounts_button') }}</button>
                <br>
...
@section('javascript')
    ...
    <script>
        $('#show_discount_table').on('click', function() {
            $('table#add_discount_product').toggleClass('hide');
        });
        ...
        function calcPrice() {
            ...
            if (sell_price.length > 0) {
                var sum = sell_price / 1000;
                $('#single_dsp').val(sum.toFixed(2));
            }
            if (purchase_price.length > 0) {
                var sum = purchase_price / 1000;
                $('#single_dpp').val(sum.toFixed(2));
            }
