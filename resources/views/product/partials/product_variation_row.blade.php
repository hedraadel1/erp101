...
<tr class="variation_row">
    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            <thead>
                <tr>
                    <th style="background: #111827 !important;color: white !important;">@lang('product.sku')</th>
                    <th style="background: #111827 !important;color: white !important;">@lang('product.value')</th>
                    <th style="background: #111827 !important;color: white !important;" class="{{ $class }}">
                        @lang('product.default_purchase_price')</th>
                    <th style="background: #111827 !important;color: white !important;" class="{{ $class }}">
                        @lang('product.profit_percent')</th>
                    <th style="background: #111827 !important;color: white !important;" class="{{ $class }}">
                    ...
                    <th style="background: #111827 !important;color: white !important;">@lang('lang_v1.variation_images')</th>
                    <th style="background: #111827 !important;color: white !important;"><button type="button"
            ...
            <tbody>
                <tr>
                    ...
                    <td class="{{ $class }}">
                        ...
                        {!! Form::text('product_variation[' . $row_index . '][variations][0][sell_price_inc_tax]', $default, [
