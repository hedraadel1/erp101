<div class="table-responsive">
    <table class="table table-bordered add_discount_product table-condensed hide" id="add_discount_product">
        ...
        <tr>
            <th>
                <input type="number" class="form-control" required name="discount_product[qun_from][]">
            </th>
            <th>
                <input type="number" class="form-control" required name="discount_product[qun_to][]">
            </th>
            <th>
                {!! Form::select('discount_product[discount_type][]', $discount_types, 'fixed', [
                    'class' => 'form-control',
                    'required',
                ]) !!}
            ...
            <th>
                <input type="number" class="form-control" name="discount_product[discount][]" required>
            </th>
            <th>
...
<script>
    function addRow() {
        var tableRow = document.getElementById("add_discount_product");
