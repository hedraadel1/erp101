...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('account.manage_your_account')
            </h3>
        </div>
    </section>
                    ...
                    --}}
                            ...
                            <li>
                                <a href="#account_setting" data-toggle="tab">
                                    <i class="fa fa-gear">&#xf013;</i> <strong>
                                        @lang('lang_v1.account_setting') </strong>
                                </a>
                            </li>
                        </ul>
                    ...
                    --}}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    <i class="fa fa-edit"></i> @lang('messages.edit')</button>
                                                                <button type="button"
                                                                    class="btn btn-danger  delete_account_type">
                                                                    <i class="fa fa-trash"></i> @lang('messages.delete')</button>
                                                                {!! Form::close() !!}
                                                            </td>
                                                        </tr>
                            ...
                            <div class="tab-pane" id="account_setting">
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="button" class="btn button-add btn-modal pull-right"
                                            data-href="{{ action('AccountSettingController@create') }}"
                                            data-container="#account_type_modal">
                                            <i class="fa fa-plus"></i> @lang('messages.add')</button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered" id="account_setting_table"
                                            style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>@lang('lang_v1.name')</th>
                                            ...
                                            <tbody>
                                                @foreach ($map_seetings as $key)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ optional($key->account)->name }}

                                                        </td>
                                                        <td>
                                                            {{ optional($key->location)->name }}
                                                        ...
                                                        <td>
                                                            @if (!$key->is_default_type)
                                                                <span style="display: flex">
                                                                    <button type="button"
                                                                        class="btn Btn-Brand  Btn-Primary btn-modal btn-xs"
                                                                        data-href="{{ action('AccountSettingController@edit', $key->id) }}"
                                                                        data-container="#account_type_modal">
                                                                        <i class="fa fa-edit"></i> @lang('messages.edit')</button>
                                                                    {{-- <div class="dropdown-divider"></div> --}}
                                                                    <form
                                                                        action="{{ action('AccountSettingController@destroy', $key->id) }}"method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="submit"
