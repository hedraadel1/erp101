...
@section('content')
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            {!! Form::select('price_group', $price_groups, $selected_price_group, [
                                                'class' => 'form-control select2 width100',
                                                'id' => 'price_group',
                                            ]) !!}
                                            <span class="input-group-addon">
    ...
    <section class="content no-print">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                @component('components.widget', ['class' => 'box-primary', 'title' => __('messages.basicdata')])
                    ...
                    <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                @endif
                                @if (request()->customer)
                                    <input type="hidden" id="default_customer_id" value="{{ request()->customer }}">
                                    <input type="hidden" id="default_customer_name" value="{{ request()->name }}">
                                ...
                                @endif
                                {!! Form::select('contact_id', [], request()->customer ?? null, [
                                ...
                                <span class="input-group-btn">
                                    <button style="padding: 6px 14px" type="button"
                                        class="btn btn-default bg-white btn-flat add_new_customer" data-name=""><i
                                            class="fa fa-plus-circle text-primary fa-lg"></i></button>
                                    <div style="padding: 6px 14px" id="link-show" type="button"
                            ...
                            <small class="text-danger hide contact_due_text"><strong>@lang('account.customer_due'):</strong>
                                <span></span></small>
                            <input type="hidden" id="contact_due_text" name="contact_due" value="0">
                        </div>
                        {{--  <small>
                            <strong>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div id="showdshipping" style="background-image: linear-gradient(#464d55, #25292e);color: #fff;"
                                role="button" class="button-30">@lang('messages.showshipping')</div>
                        ...
                        {{--    <div class="col-sm-4">
                          <div id="showdpaymentwebgit" role="button" class="button-84">@lang('messages.showpayment')</div>
                ...
                @component('components.widget', ['class' => 'box-primary', 'title' => __('messages.productdata')])
                    ...
                    <div class="row col-sm-12 pos_product_div" style="min-height: 0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-condensed table-bordered table-striped table-th-green text-center "
                                id="pos_table">
                                <thead>
                                    <tr>
        ...
        @if (!empty($common_settings['is_enabled_export']) && $sale_type != 'sales_order')
            ...
            @component('components.widget', [
                'class' => 'box-solid hide',
                'display' => 'none',
                'title' => __('lang_v1.export'),
            ])
        ...
        @endphp
        @if ((empty($status) || $is_enabled_download_pdf) && $sale_type != 'sales_order')
            @can('sell.payments')
                @component('components.widget', [
                    'class' => 'box-solid',
                    'id' => $payment_body_id,
                    ...
                    <div class="payment_row" @if ($is_enabled_download_pdf) id="payment_rows_div" @endif>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    <strong>@lang('lang_v1.balance'):</strong> <span class="balance_due">0.00</span>
                                    {{-- task-4 --}}
        ...
        @if ((empty($status) || $is_enabled_download_pdf) && $sale_type != 'sales_order')
            @can('sell.payments')
                <div hidden id='show_installment'>


                    @component('components.widget', [
                        'class' => 'box-solid',
                        'id' => $payment_body_id,
                        'title' => __('sale.installments'),
                    ])
                        <div class="payment_row" @if ($is_enabled_download_pdf) id="payment_rows_div" @endif>
                            <div class="row">
                                <div class="col-md-12 mb-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="pull-right">
                                        <strong>@lang('sale.total_installment'):</strong> <span class="balance_due">0.00</span>
                                        {{-- task-4 --}}
                                        <input type="hidden" id="balance_due" name='installment_balance_due' value=''>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class=" content-wrapper main_area " style="padding: 0px 20px">
            <div class="row">
                {!! Form::hidden('is_save_and_print', 0, ['id' => 'is_save_and_print']) !!}
                <div class="col-sm-6 text-center">
                    <button type="button" id="submit-sell" class="btn button-29 btn-big">@lang('messages.save')</button>
                </div>
                <div class="col-sm-6 text-center">
                    <button type="button" id="save-and-print" class="btn button-29 btn-big">@lang('lang_v1.save_and_print')</button>
                </div>
            </div>
        </section>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $('#showdshipping').on('click', function() {
        ...
        $('#showdiscountandtax').on('click', function() {
            $('#discountandtax').toggle(function() {
                $("#discountandtax").css({
                    display: "none"
                });
            }, function() {
