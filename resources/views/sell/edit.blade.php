...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox orange">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">{{ $title }}
                <small>(@if ($transaction->type == 'sales_order')
                        @lang('restaurant.order_no')
                    @else
                        @lang('sale.invoice_no')
                    @endif: <span class="text-success">#{{ $transaction->invoice_no }})</span></small>
            </h3>
        </div>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                @component('components.widget', ['class' => 'box-solid', 'title' => __('messages.basicdata')])
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div id="showdshipping"
                                role="button"style="background-image: linear-gradient(#464d55, #25292e);color: #fff;"
                                class="button-30">@lang('messages.showshipping')</div>

                        </div>
                        <div class="col-sm-4">
                            <div id="showdiscountandtax"
                                role="button"style="background-image: linear-gradient(#464d55, #25292e);color: #fff;"
                                class="button-30">@lang('messages.showdiscount')</div>
                ...
                @component('components.widget', ['class' => 'box-solid', 'title' => __('messages.productdata')])
        ...
        <div class="row">
            ...
            <div class="col-sm-6 text-center">
                <button type="button" class="btn button-29 btn-big" id="submit-sell">@lang('messages.update')</button>

            </div>
            <div class="col-sm-6 text-center">
                <button type="button" id="save-and-print"
                    class="btn button-29 btn-big">@lang('lang_v1.update_and_print')</button>
