<div class="pos-tab-content">
    <div class="row">
        ...
        @if ($enable_installment == true)
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" {{ !empty($pos_settings['installment_sales']) ? 'checked' : '' }}
                                name="pos_settings[installment_sales]" value="1" class="input-icheck"
                                id="installment_sales">{{ __('lang_v1.installment_sales') }}

                        </label>
                        @show_tooltip(__('lang_v1.installment_sales'))
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" {{ !empty($pos_settings['enable_default_customer']) ? 'checked' : '' }}
                            name="pos_settings[enable_default_customer]" value="1" class="input-icheck"
                            id="enable_default_customer">{{ __('lang_v1.enable_default_customer') }}

                    </label>
                    @show_tooltip(__('lang_v1.enable_default_customer'))
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('pos_settings[commission_user_login]', 1, !empty($pos_settings['commission_user_login']), [
                            'class' => 'input-icheck',
                            'id' => 'commission_user_login',
                        ]) !!} {{ 'عمولة ل ' . __('lang_v1.logged_in_user') }}
                    </label>
                </div>
            </div>
        </div>
