        ...
        <div class="col-sm-6">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['pay_n_ckeckout']) ? $shortcuts['pos']['pay_n_ckeckout'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text('shortcuts[pos][draft]', !empty($shortcuts['pos']['draft']) ? $shortcuts['pos']['draft'] : null, [
                            'class' => 'form-control',
                        ]) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['cancel']) ? $shortcuts['pos']['cancel'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['recent_product_quantity']) ? $shortcuts['pos']['recent_product_quantity'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['weighing_scale']) ? $shortcuts['pos']['weighing_scale'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['edit_discount']) ? $shortcuts['pos']['edit_discount'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['edit_order_tax']) ? $shortcuts['pos']['edit_order_tax'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['add_payment_row']) ? $shortcuts['pos']['add_payment_row'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['finalize_payment']) ? $shortcuts['pos']['finalize_payment'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        {!! Form::text(
                            ...
                            !empty($shortcuts['pos']['add_new_product']) ? $shortcuts['pos']['add_new_product'] : null,
                            ['class' => 'form-control'],
                        ) !!}
                    </td>
                </tr>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('pos_settings[disable_draft]', 1, empty($pos_settings['disable_draft']) ? 0 : 1, [
                            'class' => 'input-icheck',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('pos_settings[disable_suspend]', 1, empty($pos_settings['disable_suspend']) ? 0 : 1, [
                            'class' => 'input-icheck',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('pos_settings[show_invoice_scheme]', 1, empty($pos_settings['show_invoice_scheme']) ? 0 : 1, [
                            'class' => 'input-icheck',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('pos_settings[show_invoice_layout]', 1, !empty($pos_settings['show_invoice_layout']), [
                            'class' => 'input-icheck',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('pos_settings[print_on_suspend]', 1, !empty($pos_settings['print_on_suspend']), [
                            'class' => 'input-icheck',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
                            'pos_settings[show_filter_variation_template]',
                            1,
                            !empty($pos_settings['show_filter_variation_template']),
                            ['class' => 'input-icheck'],
                        ) !!} {{ __('lang_v1.show_filter_variation_template') }}
                    </label>
                </div>
            </div>
        </div>
        @if (is_product_enabled('250'))
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="checkbox">
                        <br>
                        <label>
                            {!! Form::checkbox('pos_settings[show_invoice_booking]', 1, !empty($pos_settings['show_invoice_booking']), [
                                'class' => 'input-icheck',
                            ]) !!} {{ __('lang_v1.show_invoice_booking') }}
                        </label>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="checkbox">
                        <br>
                        <label>
                            {!! Form::checkbox('pos_settings[show_product_booking]', 1, !empty($pos_settings['show_product_booking']), [
                                'class' => 'input-icheck',
                            ]) !!} {{ __('lang_v1.show_product_booking') }}
                        </label>
                    </div>
                </div>
            </div>
