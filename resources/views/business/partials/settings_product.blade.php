<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        {{--      Added two new checkboxes for category2 and category3 filteration --}}
        @if (is_product_enabled('242'))
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('enable_category2', 1, $business->enable_category2, [
                                'class' => 'input-icheck',
                                'id' => 'enable_category2',
                            ]) !!} {{ __('lang_v1.enable_category2') }}
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('enable_category3', 1, $business->enable_category3, [
                                'class' => 'input-icheck',
                                'id' => 'enable_category3',
                            ]) !!} {{ __('lang_v1.enable_category3') }}
                        </label>
                    </div>
                </div>
            </div>
