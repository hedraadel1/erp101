...
@if (count($all_locations) > 1)
    <div class="col-md-6 ">
        {!! Form::label('sell_list_filter_location_id', __('lang_v1.select_location') . ':') !!}
        {!! Form::select('sell_list_filter_location_id', $all_locations, null, [
...
<div class="col-sm-12 ">
    <div class="">
        <table class="table table-bordered table-striped ajax_view" id="sell_table_home" style="width: 100%">
            <thead>
                <tr>
