...
@section('content')
    ...
    <!-- Main content -->
    <section class="content content-custom no-print row row-custom"  style="margin-top: -160px;">
        <br>
        ...
        @if (auth()->user()->can('dashboard.data'))
            @if ($is_admin)
                ...
                <div style="height: 53px" class=" button-header-40">
                    <div style="width:100%" class="form-group ">
                        <div style="width:100%" class="input-group">
                            <button style="width:100%" type="button" class="btn btn-primary" id="dashboard_date_filter">
                                <span>
                ...
                @component('components.widget', [
                    ...
                    {{-- <div style="margin-top: -60px;" class="row">
                        <!-- /.col -->
                        <div class="col-xs-12">
                            <div class="Fast_Report_Box fastreportboxheight info-box-new-style">
            ...
            @if (auth()->user()->can('sell.view') ||
                ...
                @if (!empty($all_locations))
                    <!-- sales chart start -->
                    @component('components.widget', ['class' => 'box-primary width100', 'title' => __('home.sells_last_30_days')])
                ...
                @if (!empty($all_locations))
                    ...
                    @component('components.widget', ['class' => 'box-primary width100', 'title' => __('home.sells_current_fy')])
