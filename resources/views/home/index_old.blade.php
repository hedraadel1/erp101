...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/custom_style_home.css') }}">
@endsection
@section('content')
        ...
        @if (auth()->user()->can('dashboard.data'))
            @if ($is_admin)
                <div class="col-md-12">
                    ...
                    <div class="row info-box info-box-new-style" style="margin: 0px 0px 20px;">
                        <div class="col-sm-12 p-4">

                            <h3><b> <span data-feather="filter"></span> {{ __('report.filters') }}</b></h3>
                        </div>
    ...
    'title' => __('lang_v1.Fast_Report'),
                ...
                <div class="row row-custom">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style ">
                            <span class="info-box-icon bg-light-primary">
                                <i class="feather-35" data-feather="shopping-bag"></i></span>
                            </span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style ">
                            <span class="info-box-icon text-green" style="background: #2dce8938;">
                                <i class="feather-35" data-feather="clipboard"></i></span>
                            </span>
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('lang_v1.net') }}
                                    @show_tooltip(__('lang_v1.net_home_tooltip'))</span>
                                <span class="info-box-number net"> </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style ">
                            <span class="info-box-icon" style="color:#ff7600;background: #ff760038;">
                                <i class="feather-35" data-feather="file-text"></i>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style ">
                            <span class="info-box-icon "style="color:#ff006a;background: #ff006a1f;">
                                <i class="feather-35" data-feather="repeat"></i>
                            </span>
                            </span>
                            <div class="info-box-content">
                ...
                <div class="row row-custom">
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style ">
                            <span class="info-box-icon text-aqua" style="background: #11cdef33">
                                <i class="ion ion-cash" style="font-size: 40px"></i>
                            </span>
                            </span>
                            <div class="info-box-content">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style ">
                            <span class="info-box-icon text-yellow" style="background: #ffad4652;">
                                <i class="ion ion-cash" style="font-size: 40px"></i>
                                <i class="fa fa-exclamation"></i>
                            </span>
                            </span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style ">
                            <span class="info-box-icon  text-red" style="background: #f5365c26;">
                ...
                @component('components.custom_widget', [
                    'class' => 'box-primary',
                    'display' => 'contents',
                    'title' => __('lang_v1.Fast_Report'),
                ])
        ...
        @endcomponent --}}
            ...
            @if (auth()->user()->can('sell.view') ||
                ...
                @if (!empty($all_locations))
                    ...
                    <div class="col-sm-6">
                        ...
                        @component('components.custom_widget', ['class' => 'box-primary', 'title' => __('home.sells_last_30_days')])
                ...
                @if (!empty($all_locations))
                    ...
                    <div class="col-sm-6">
                        @component('components.custom_widget', ['class' => 'box-primary', 'title' => __('home.sells_current_fy')])
            ...
            @if (auth()->user()->can('sell.view') ||
                    auth()->user()->can('direct_sell.view'))
                <div class="col-sm-6">
                    @component('components.custom_widget', ['class' => 'box-warning'])
                        {{--     @slot('icon')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        @component('components.custom_widget', ['class' => 'box-warning'])
                            ...
                            @endif
                            <table class="table table-bordered table-striped" id="most_product_sell_table">
                                <thead>
                                    <tr>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        var most_product_sell_table = $('#most_product_sell_table').DataTable({
            processing: true,
            serverSide: true,
            aaSorting: [
                [2, 'desc']
            ...
            ajax: {
                "url": "{{ route('get.most.product.sell') }}",
                "data": function(d) {
                    if ($('#most_product_location').length > 0) {
                        d.location_id = $('#most_product_location').val();
                    }
                }
            },
            ...
            fnDrawCallback: function(oSettings) {
                __currency_convert_recursively($('#most_product_sell_table'));
            },
        });
        $('#most_product_location').change(function() {
            most_product_sell_table.ajax.reload();
        });
    </script>
@endsection
