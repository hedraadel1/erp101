<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('ZoneController@store'),
            'method' => 'post',
            'id' => 'zone_add_form',
        ]) !!}
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('lang_v1.add_zone')</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('zone_name', null, ['class' => 'form-control', 'required', 'placeholder' => 'أسم المنطقة']) !!}
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="">{{ __('lang_v1.lat') }} :*</label>
                        <input type="number" step="any" min="0" value="" required class="form-control"
                            id="" name="zone_lat">
                    </div>
