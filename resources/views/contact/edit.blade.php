    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 {{ $contact->type == 'both' ? 'hide' : '' }}">
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        {!! Form::text('region', $contact->region, ['class' => 'form-control', 'placeholder' => __('lang_v1.region')]) !!}
                    </div>
                </div>
                ...
                <div id="more_div" class="hide">
                    ...
                    <div class="col-md-4 opening_balance hide">
                        <div class="form-group">
