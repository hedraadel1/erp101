    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-3 mt-15" style="    margin-top: 35px;">
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        {!! Form::text('region', null, ['class' => 'form-control', 'placeholder' => __('lang_v1.region')]) !!}
                    </div>
                </div> --}}
                ...
                <div class="col-md-6 opening_balance">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('opening_balance', 0, ['class' => 'form-control input_number pull-left']) !!}

                        </div>

                    </div>
                </div>
                <div class="col-md-3 opening_balance" style="    margin-top: 35px;">
                    <div class="form-group">
                        <div class="  pull-left">
                            <input type="radio" id="customRadio1" checked name="opening_balance_type" value="credit"
                                class="custom-control-input">
                            <label class="custom-control-label" for="customRadio1">رصيد متاح له</label>
                        </div>
                ...
                <div class="col-md-3 opening_balance" style="    margin-top: 35px;">
                    <div class="form-group">
                        <div class="  pull-left">
                            <input type="radio" id="customRadio2" name="opening_balance_type" value="debit"
                                class="custom-control-input">
                            <label class="custom-control-label" for="customRadio2">رصيد مستحق عليه</label>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12 opening_balance">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('opening_balance', 0, ['class' => 'form-control input_number  width-40 pull-left']) !!}
                                <div class="  pull-left" style="width: 30%">
                                    <input type="radio" id="customRadio1" checked name="opening_balance_type"
                                        value="credit" class="custom-control-input">
                                    <label class="custom-control-label" for="customRadio1">رصيد متاح له</label>
                                </div>
                                <div class="  pull-left" style="width: 30%">
                                    <input type="radio" id="customRadio2" name="opening_balance_type"
                                        value="debit" class="custom-control-input">
                                    <label class="custom-control-label" for="customRadio2">رصيد مستحق عليه</label>
                                </div>
                            </div>
