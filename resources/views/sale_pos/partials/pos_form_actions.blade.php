    ...
    <div style="margin-right: unset;border-radius: 25px;  background: linear-gradient(to right, #232526, #414345);padding-right: 10px;padding-left: 10px;"
        ...
        @if ($is_mobile)
            <div class="col-md-12 text-right">
                ...
                <span id="total_payable" class="text-success btn-sm lead text-bold text-right">0</span>
            </div>
        @endif
        <button type="button"
        ...
        <button type="button"
            ...
            data-container=".modal_payment" id="pos-finalize" title="@lang('lang_v1.tooltip_checkout_multi_pay')"><i
        ...
        @if (!empty($pos_settings['show_invoice_booking']))
            <button type="button"
                ...
                data-toggle="modal" data-target="#invoice_booking_modal" id="invoice_booking"> <i
                    class="fas fa-file"></i>
        ...
        @if (!empty($pos_settings['show_product_booking']))
            <button type="button"
                ...
                data-toggle="modal" data-target="#product_booking_modal" id="product_booking"> <i
                    class="fas fa-list"></i>
