<div class="modal fade" role="dialog" id="modal_payment">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary" id="pos-save" name="invoice_booking"
                    value="@lang('lang_v1.invoice_booking')">
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
