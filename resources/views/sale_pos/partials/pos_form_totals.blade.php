<div style="margin-right: unset;border-radius: 25px;background: whitesmoke;" class="row pos_form_totals box box-solid" >
	<div class="col-md-12">
		<table style="margin-bottom:10px !important" class="table table-condensed">
			<tr>
