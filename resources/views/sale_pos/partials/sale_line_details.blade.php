<table class="table bg-gray">
    ...
    @foreach($sell->sell_lines as $sell_line)
        <tr>
            ...
            @endif
            @if($sell->type == 'sales_order')
                <td><span class="display_currency" data-currency_symbol="false" data-is_quantity="true">{{ $sell_line->quantity - $sell_line->so_quantity_invoiced }}</span> @if(!empty($sell_line->sub_unit)) {{optional($sell_line->sub_unit)->short_name}} @else {{optional(optional($sell_line->product)->unit)->short_name}} @endif</td>
            @endif
            <td>
                <span class="display_currency" data-currency_symbol="false" data-is_quantity="true">{{ $sell_line->quantity }}</span> @if(!empty($sell_line->sub_unit)) {{optional($sell_line->sub_unit)->short_name}} @else {{optional(optional($sell_line->product)->unit)->short_name}} @endif
