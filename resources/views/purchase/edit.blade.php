...
@section('content')
    ...
    <section style="margin-top: -25px;" class="content-header">
        <div class="newbox orange">
            <h3 style="margin-top: 10px;margin-bottom: 10px;">@lang('purchase.edit_purchase') <i class="fa fa-keyboard-o hover-q text-muted"
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <button type="button" id="submit_purchase_form"
                    class="btn button-29 btn-big">@lang('messages.update')</button>
            </div>
        </div>
        {!! Form::close() !!}
    </section>
