@foreach ($variations as $variation)
    <tr @if (!empty($purchase_order_line)) data-purchase_order_id="{{ $purchase_order_line->transaction_id }}" @endif>
        ...
        <td>
            ...
            <a data-href="{{action('ProductController@getProductSerialModal', $product->id)}}" data-container=".product_serial_modal" class="btn Btn-Brand btn-info btn-xs btn-modal">السريلات</a>
          @endif
        </td>
        <td>
