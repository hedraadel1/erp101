                ...
                @elseif(in_array($due_payment_type, ['sell']))
                    <div class="col-md-6">
                        <div class="well">
                            ...
                            <input style="display: none" type="" class="$isinsval" value='{{ $isinsval }}'>
                            <input style="display: none" type="" class="$isid" value='{{ $isid }}'>
                            <br><br>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            @else
                                {!! Form::text('amount', @num_format($valueofpayment), [
                                    'class' => 'form-control input_number payment_amount width-40 pull-left',
                                    'required',
                                    'placeholder' => __('sale.amount'),
                                ]) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select(
                                    'account_id',
                                    $accounts,
                                    !empty($payment_line->account_id) ? $payment_line->account_id : $account->account_id ?? null,
                                    [
                                        'class' => 'form-control select2',
                                        'id' => 'account_id',
                                        'style' => 'width:100%;',
