<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open([
            'url' => action('SupervisorController@postAssignUsers'),
            'method' => 'post',
        ...
        <div class="modal-body">
            {!! Form::hidden('supervisor_id', $supervisor->id) !!}
            <table class="table table-condensed">
                ...
                <tbody>
                    @foreach ($users as $key => $value)
                        ...
                        <tr>
                            <td>{!! Form::checkbox('user_supervisor[' . $key . '][is_added]', 1, array_key_exists($key, $user_supervisor), [
                                'id' => 'user_check_' . $key,
                            ]) !!}</td>
                            <td>{{ $value }}</td>
                            {{-- <td>
