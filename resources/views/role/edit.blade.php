...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('role.edit_role')
            </h3>
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('user.update_password', $role_permissions),
                                    [
                                        'class' => 'input-icheck',
                                    ],
                                ) !!} امكانية تغيرر كلمة المرور
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'purchase.stock_update_status',
                                        in_array('purchase.stock_update_status', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    السماح للمندوب بتغيير حاله الفاتوره في تحويل المخزون
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'view_istallment_dashboard',
                                    in_array('view_istallment_dashboard', $role_permissions),
                                    [
                                        'class' => 'input-icheck',
                                    ],
                                ) !!} {{ __('lang_v1.view_istallment_dashboard') }}
                            </label>
                        </div>
                    </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('view_restaurant_order', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} امكانية استخدام ادارة الطلبات
                                </label>
                            </div>
                        </div>
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'connect_view', in_array('connect_view', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} امكانية استخدام قسم ال API
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'enable_catalogue_view',
                                        in_array('enable_catalogue_view', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} امكانية استخدام قسم الديجيتال منيو
                                </label>
                            </div>
                        </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'ticket_view', in_array('ticket_view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.view_tickets') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'open_ticket', in_array('open_ticket', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.open_ticket') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit_ticket', in_array('edit_ticket', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.edit_ticket') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'replay_ticket', in_array('replay_ticket', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.replay_ticket') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delete_ticket', in_array('delete_ticket', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.delete_ticket') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'view_warehouse', in_array('view_warehouse', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.view_warehouse') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit_warehouse', in_array('edit_warehouse', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.edit_warehouse') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'add_warehouse', in_array('add_warehouse', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.add_warehouse') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn button-29  pull-right">@lang('messages.update')</button>
                </div>
            </div>
