...
@section('content')
    ...
    <section style="margin-top: -25px" class="content-header">
        <div style="display:block;" class="newbox blackline">
            <h3 style="{{ isMobile() ? 'margin: -15px;' : '' }}  justify-content: center;display: flex;">@lang('role.add_role')
            </h3>
    </section>
        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'user.update_password', false, ['class' => 'input-icheck']) !!} امكانية تغيرر كلمة المرور
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'purchase.stock_update_status', false, ['class' => 'input-icheck']) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'view_istallment_dashboard', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_istallment_dashboard') }}
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'view_ticket', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_tickets') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'open_ticket', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.open_ticket') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit_ticket', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.edit_ticket') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'replay_ticket', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.replay_ticket') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delete_ticket', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.delete_ticket') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'view_restaurant_order', false, ['class' => 'input-icheck']) !!} امكانية استخدام ادارة الطلبات
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'connect_view', false, ['class' => 'input-icheck']) !!} امكانية استخدام قسم ال API
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'enable_catalogue_view', false, ['class' => 'input-icheck']) !!} امكانية استخدام قسم الديجيتال منيو
                            </label>
                        </div>
                    </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'view_warehouse', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_warehouse') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit_warehouse', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.edit_warehouse') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'add_warehouse', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.add_warehouse') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12" style="padding-top:10px ">
                    <button type="submit" class="btn button-29 btn-block pull-right">@lang('messages.save')</button>
                </div>
            </div>
