...
@section('content')
    ...
    <section class="content no-print">
        ...
        {!! Form::open([
            'url' => action('SellReturnController@sellReturnReplace'),
            'method' => 'post',
            // 'id' => 'sell_return_form',
        ]) !!}
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::label('invoice_no', $invoice_number, ['class' => 'form-control']) !!}
                            <input type="hidden" id="invoice_num" name="invoice_num" value="<?php echo $invoice_number; ?>">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                        ...
                        <table class="table bg-gray" id="sell_return_table">
                            ...
                            <tbody>
                                @foreach ($sell->sell_lines as $sell_line)
                                    @php
                                        $check_decimal = 'false';
                                        if (optional(optional($sell_line->product)->unit)->allow_decimal == 0) {
                                            $check_decimal = 'true';
                                        }
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="submit" class="button btn btn-primary js-button">التالي</button>
                        {{-- <a href="#" id="sell_return_next" class="button js-button" role="button">التالي</a> --}}
                    </div>
                </div>
            </div>
        </div>
