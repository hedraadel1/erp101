$(document).ready(function ()
{
  ...
  {
    e.preventDefault();
    if ($(this).is("#close_register"))
    {
      var href = $(this).data('href');
      var container2 = $(this).data('container');
      $.ajax({
        url: "/business/check-setting-password",
        dataType: 'json',
        method: 'GET',
        data: {
          'check_pass': 'enable_password_close_cash',
        },
        success: function (result)
        {
          ...
          if (result == true)
          {
            ...
            $('#confirm_password').find('#page_type').val('enable_password_close_cash');
            $('#confirm_password').find('#item_href').val(href);
            $('#confirm_password').find('#container').val(container2);
            $('#confirm_password').find('#password').val('');
            $('#confirm_password').find('div#msgErr').html('');
  ...
  $(document).on('click', 'button.confirm_password_pos', function (e)
  {
    e.preventDefault();

    $.ajax({
      url: "/confirm-setting-password",
      dataType: 'html',
      method: 'POST',
      data: {
      ...
      success: function (result)
      {
        ...
        if (result == 'true')
        {
          ...
          var href = $('#confirm_password').find('#item_href').val();
          var container = $('#confirm_password').find('#container').val();
          // var container = $(this).data('container');
          $.ajax({
            url: href,
            dataType: 'html',
        ...
        {
          $('.confirm_password_pos').parents().find('div#msgErr').html('');
          $('.confirm_password_pos').parents().find('div#msgErr').append('كلمة المرور غير صحيحة');
        }
      },
    });
  });
  ...
  $(document).on('submit', 'form#category2_add_form', function (e)
  {
    e.preventDefault();
    var form = $(this);
    ...
    $.ajax({
      ...
      success: function (result)
      {
        ...
        {
          $('div.category2_modal').modal('hide');
          toastr.success(result.msg);
          category2_table.ajax.reload();
        } else
        {
  ...
  //category2_table table
  var category2_table = $('#category2_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('click', 'button.edit_category2_button', function ()
  {
    $('div.category2_modal').load($(this).data('href'), function ()
    {
      $(this).modal('show');

      $('form#category2_edit_form').submit(function (e)
      {
        e.preventDefault();
        var form = $(this);
        var data = form.serialize();
  ...
  $(document).on('click', 'button.delete_category2_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_category2,
      icon: 'warning',
      buttons: true,
      dangerMode: true,
    }).then(willDelete =>
  ...
  //category3_table table
  var category3_table = $('#category3_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('click', 'button.edit_category3_button', function ()
  {
    $('div.category3_modal').load($(this).data('href'), function ()
    {
      $(this).modal('show');

      $('form#category3_edit_form').submit(function (e)
      {
        e.preventDefault();
        var form = $(this);
        var data = form.serialize();
        ...
        $.ajax({
          ...
          success: function (result)
          {
            if (result.success == true)
            {
              $('div.category3_modal').modal('hide');
              toastr.success(result.msg);
              category3_table.ajax.reload();
            } else
            {
              toastr.error(result.msg);
            }
  ...
  $(document).on('click', 'button.delete_category3_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_category2,
  ...
  var all_supervisors_table = $('table#all_supervisors_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  //start setting whatsapp_notifications
  whatsapp_notifications = $('table#whatsapp_notifications').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
    ...
    ajax: {
      url: "/settings/whatsapp-notification",
    },
    columns: [
      {
        data: 'msg_details',
  ...
  $(document).on('submit', 'form#whatsapp_notifications_form', function (e)
  {
    e.preventDefault();
    var form = $(this);
    var data = form.serialize();
    ...
    $.ajax({
      ...
      success: function (result)
      {
        if (result.success == true)
        {
          $('div.whatsapp_notifications').modal('hide');
          toastr.success(result.msg);
  ...
  $(document).on('click', 'button.delete_whatsapp_notifications_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
      icon: 'warning',
      buttons: true,
      dangerMode: true,
    }).then(willDelete =>
  ...
  //start setting gofast crud
  setting_gofast = $('table#setting_gofast').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('submit', 'form#menu_form', function (e)
  {
    e.preventDefault();
    var form = $(this);
    var data = form.serialize();
    ...
    $.ajax({
      ...
      success: function (result)
      {
        if (result.success == true)
        {
          $('div.menu_modal').modal('hide');
          toastr.success(result.msg);
          setting_gofast.ajax.reload();
        } else
        {
          toastr.error(result.msg);
        }
  ...
  $(document).on('click', 'button.delete_menu_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
  ...
  // end Crud
  //start business/deposit_requests
  deposit_requests_code_table = $('table#deposit_requests_code_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
    ...
    ajax: {
      url: "/superadmin/deposit_requests_code",
    },
    columns: [{
      data: 'id',
      name: 'id'
  ...
  $(document).on('click', 'button.delete_code_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
  ...
  all_deposit_requests_table = $('table#all_deposit_requests_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
    ...
    ajax: {
      url: "/superadmin/deposit_requests",
    },
    columns: [{
      data: 'business_id',
      name: 'business_id'
  ...
  deposit_requests_table = $('table#deposit_requests_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('click', 'button.delete_deposit_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
  ...
  //business_category
  all_business_categories = $('table#all_business_categories').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('submit', 'form#business_category_form', function (e)
  {
    e.preventDefault();
    var form = $(this);
    var data = form.serialize();
    ...
    $.ajax({
      ...
      success: function (result)
      {
        if (result.success == true)
        {
          $('div.business_categories_modal').modal('hide');
          toastr.success(result.msg);
          all_business_categories.ajax.reload();
        } else
        {
          toastr.error(result.msg);
        }
  ...
  $(document).on('click', 'button.delete_business_category_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
  ...
  education_categories = $('table#education_categories').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('submit', 'form#education_category_form', function (e)
  {
    e.preventDefault();
    var form = $(this);
    var data = form.serialize();
    ...
    $.ajax({
      ...
      success: function (result)
      {
        if (result.success == true)
        {
          $('div.education_category_modal').modal('hide');
          toastr.success(result.msg);
          education_categories.ajax.reload();
        } else
        {
          toastr.error(result.msg);
        }
  ...
  $(document).on('click', 'button.delete_education_category_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
  ...
  //start education video crud
  education_videos = $('table#education_videos').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('submit', 'form#education_video_form', function (e)
  {
    e.preventDefault();
    var form = $(this);
    ...
    var videoId = getId($(this).find('#video_url').val());
    ...
    data.append('name', $(this).find('#video_name').val());
    data.append('category_id', $(this).find('#video_category').val());
    data.append('description', $(this).find('#video_description').val());
    data.append('video_id', videoId);
    data.append('video_url', $(this).find('#video_url').val());
      ...
      xhr: function ()
      {
        ...
        xhr.upload.addEventListener("progress", function (evt)
        {
          if (evt.lengthComputable)
          {
            ...
            if (files.length > 0)
            {
              $(".progress-bar").width(Math.round(percentComplete, 0) + '%');
              $(".progress-bar").html(' جاري التحميل...  ' + Math.round(percentComplete, 0) + '%');
            }
          }
        }, false);
        return xhr;
  ...
  $(document).on('click', 'button.delete_education_video_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
  ...
  //start superadmin_products_table crud
  superadmin_products_table = $('table#superadmin_products_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
    ...
    columns: [
      ...
      { data: 'free_price', name: 'free_price' },
  ...
  $(document).on('click', 'button.edit_superadmin_products_button', function ()
  {
    $('div.warehouse_categories_modal').load($(this).data('href'), function ()
    {
      $(this).modal('show');
    });
  });
  $(document).on('click', 'button.superadmin_products_show', function ()
  {
    $('div.superadmin_products_show').load($(this).data('href'), function ()
    {
      $(this).modal('show');
    });
  });

  $(document).on('click', 'button.delete_superadmin_products_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_superadmin_products,
      icon: 'warning',
      buttons: true,
      dangerMode: true,
    }).then(willDelete =>
      ...
      if (willDelete)
      {
        ...
        $.ajax({
          ...
          success: function (result)
          {
            ...
            {
              toastr.success(result.msg);
              superadmin_products_table.ajax.reload();
            } else
            {
              toastr.error(result.msg);
            }
  ...
  // end Crud
  //start warehouse inventory crud
  warehouse_inventory_table = $('table#warehouse_inventory_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('click', 'button.edit_warehouse_inventory_button', function ()
  {
    $('div.warehouse_categories_modal').load($(this).data('href'), function ()
    {
      $(this).modal('show');
  ...
  $(document).on('click', 'button.warehouse_inventory_show', function ()
  {
    $('div.warehouse_inventory_show').load($(this).data('href'), function ()
    {
      $(this).modal('show');
    });
  });

  $(document).on('click', 'button.delete_warehouse_inventory_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_inventory,
      ...
      if (willDelete)
      {
        ...
        $.ajax({
          ...
          success: function (result)
          {
            ...
            {
              toastr.success(result.msg);
              warehouse_inventory_table.ajax.reload();
            } else
            {
              toastr.error(result.msg);
            }
  ...
  warehouse_category_table = $('table#warehouse_category_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
  ...
  $(document).on('click', 'button.edit_warehouse_category_button', function ()
  {
    $('div.warehouse_categories_modal').load($(this).data('href'), function ()
    {
      $(this).modal('show');
  ...
  $(document).on('click', 'button.delete_warehouse_category_button', function ()
  {
    swal({
      title: LANG.sure,
      text: LANG.confirm_delete_warehouse_category,
      icon: 'warning',
      buttons: true,
      dangerMode: true,
    }).then(willDelete =>
      ...
      if (willDelete)
      {
        ...
        $.ajax({
          ...
          success: function (result)
          {
            ...
            {
              toastr.success(result.msg);
              warehouse_category_table.ajax.reload();
            } else
            {
              toastr.error(result.msg);
            }
  ...
  var all_zone_table = $('table#all_zone_table').DataTable({
    processing: true,
    serverSide: true,
    fixedHeader: false,
    ...
    columns: [
      ...
      { data: 'zone_long', name: 'zone_long' },
      { data: 'zone_lat', name: 'zone_lat' },
      { data: 'max_away', name: 'max_away' },
      { data: 'action', name: 'action' },
    ],
    columnDefs: [{
      targets: 4,
  ...
  $(document).on('click', 'button.edit_zone_button', function ()
  {
    $('div.zone_modal').load($(this).data('href'), function ()
    {
      $(this).modal('show');

      $('form#zone_edit_form').submit(function (e)
      {
        e.preventDefault();
        var form = $(this);
        var data = form.serialize();
        ...
        $.ajax({
          ...
          success: function (result)
          {
            if (result.success == true)
            {
              $('div.zone_modal').modal('hide');
              toastr.success(result.msg);
              all_zone_table.ajax.reload();
            } else
            {
              toastr.error(result.msg);
            }
  ...
  $(document).on('click', 'button.delete_zone_button', function ()
  {
    swal({
      title: LANG.sure,
  ...
  $(document).on('click', 'button.edit_unit_product_price', function ()
  {
    $('div.unit_modal').load($(this).data('href'), function ()
    {
      $(this).modal('show');
  ...
  $('#region').on('keyup', function ()
  {
    ...
    console.log(data);
    contact_table.ajax.url(url + "?" + $.param(data)).load();
  });
  ...
  $(document).on('click', 'a.pay_purchase_due, a.pay_sale_due', function (e)
  {
    ...
    $.ajax({
      ...
      method: 'GET',
      data: {
        'check_pass': 'enable_password_for_pay_contant',
      },
      success: function (result)
      {
        // alert(result == true);
        ...
        {
          $('#confirm_password').modal('show');
          $('#confirm_password').find('#page_type').val('enable_password_for_pay_contant');
          $('#confirm_password').find('#item_href').val('');
          $('#confirm_password').find('#item_href').val(href);
          $('#confirm_password').find('#password').val('');
          $('.confirm_password_contact').parents().find('div#msgErr').html('');
  ...
  $(document).on('click', 'button.confirm_password_contact', function (e)
  {
    e.preventDefault();
    ...
    $.ajax({
      ...
      success: function (result)
      {
        ...
        {
          $('.confirm_password_contact').parents().find('div#msgErr').html('');
          $('.confirm_password_contact').parents().find('div#msgErr').append('كلمة المرور غير صحيحة');
        }
      },
    });
  });
  ...
  $('#view_todays_profit_home').click(function ()
  {
    var loader = '<div class="text-center">' + __fa_awesome() + '</div>';
    $('#todays_profit').html(loader);
    $('#todays_profit_modal').modal('show');
  ...
  $(document).on('click', '.delete-sale', function (e)
  {
    ...
    $.ajax({
      ...
      method: 'GET',
      data: {
        'check_pass': 'enable_password_delete_purchase',
      },
      success: function (result)
      {
        // alert(result == true);
        ...
        {
          $('#confirm_password').modal('show');
          $('#confirm_password').find('#page_type').val('enable_password_delete_sell');
          $('#confirm_password').find('#password').val('');
          $('#confirm_password').find('#item_href').val('');
          $('#confirm_password').find('#item_href').val(href);
          if (is_suspended) { $('#confirm_password').find('#is_suspended').val(is_suspended); }
        ...
        } else
        {
          ...
          }).then(willDelete =>
          {
            ...
            {
              var href = $(this).attr('href');
              var is_suspended = $('a.delete-sale').hasClass('is_suspended');
              $.ajax({
                method: 'DELETE',
                url: href,
                dataType: 'json',
  ...
  $(document).on('click', 'button.confirm_password_setting', function (e)
  {
    e.preventDefault();
    ...
    $.ajax({
      ...
      success: function (result)
      {
        ...
        if (result == 'true')
        {
          ...
          }).then(willDelete =>
          {
            if (willDelete)
            {
              // var href = $(this).attr('href');
              var href = $('#confirm_password').find('#item_href').val();
              var is_suspended = $('#confirm_password').find('#is_suspended').val();
              alert(is_suspended);
              // var is_suspended = $(this).hasClass('is_suspended');
              $.ajax({
                method: 'DELETE',
        ...
        {
          $('.confirm_password_setting').parents().find('div#msgErr').html('');
          $('.confirm_password_setting').parents().find('div#msgErr').append('كلمة المرور غير صحيحة');
        }
      },
    });
  });
...
/**
 * get this unit to check if is-for-price or no
 * change select sub_unit_ids if multiple or no
 * 20-4-2023
 */
function get_unit()
{
  ...
  if ($('#sub_unit_ids').is(':visible'))
  {
    ...
    $.ajax({
      ...
      success: function (result)
      {
        ...
        if (result == '1')
        {
          $('#sub_unit_ids').removeAttr('multiple')
        } else
        {
          $('#sub_unit_ids').attr('multiple', 'multiple');
        }
      },
    });
  }
...
$('#location_id').on('change', function ()
{
  ...
  console.log(data);
  warehouse_table.ajax.url(url + "?" + $.param(data)).load();
});
$('#warehouse_category_id').on('change', function ()
{
  var url = "/warehouses";
  var data = {
    warehouse_category_id: $(this).val(),
  };
  console.log(data);
  warehouse_table.ajax.url(url + "?" + $.param(data)).load();
});
